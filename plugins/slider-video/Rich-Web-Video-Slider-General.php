		...
		<div class='Rich_Web_VSlider_Opt_Table_Data_2'>
			...
			<table class='Rich_Web_VSlider_Save_Table_2' id="Rich_Web_VSlider_Save_Table_2_1">
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS1[0]->Rich_Web_VS_CP_S;?>" id="Rich_Web_VS_CP_S" name="Rich_Web_VS_CP_S" min="1" max="30">
							<span class="range-slider__value" id="Rich_Web_VS_CP_S_1">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS1[0]->Rich_Web_VS_CP_BlC;?>" id="Rich_Web_VS_CP_BlC" name="Rich_Web_VS_CP_BlC" min="1" max="30">
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS1[0]->Rich_Web_VS_CP_BlR;?>" id="Rich_Web_VS_CP_BlR" name="Rich_Web_VS_CP_BlR" min="1" max="30">
							<span class="range-slider__value" id="Rich_Web_VS_CP_BlR_1">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS1[0]->Rich_Web_VS_CP_AS;?>" id="Rich_Web_VS_CP_AS" name="Rich_Web_VS_CP_AS" min="100" max="1500" step='100'>
							<span class="range-slider__value" id="Rich_Web_VS_CP_AS_1">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS1[0]->Rich_Web_VS_CP_PT;?>" id="Rich_Web_VS_CP_PT" name="Rich_Web_VS_CP_PT" min="1" max="15">
							<span class="range-slider__value" id="Rich_Web_VS_CP_PT_1">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS1[0]->Rich_Web_VS_CP_SS;?>" id="Rich_Web_VS_CP_SS" name="" min="1" max="20">
				...
				<tr>
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_CS_BSC" value="<?= $Rich_Web_VS1[0]->Rich_Web_VS_CS_BSC;?>"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS1[0]->Rich_Web_VS_CP_BW;?>" id="Rich_Web_VS_CP_BW" name="Rich_Web_VS_CP_BW" min="0" max="15">
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_CS_BC" value="<?= $Rich_Web_VS1[0]->Rich_Web_VS_CS_BC;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS1[0]->Rich_Web_VS_CP_BR;?>" id="Rich_Web_VS_CP_BR" id="Rich_Web_VS_CP_BR" name="Rich_Web_VS_CP_BR" min="0" max="20">
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS1[0]->Rich_Web_VS_SL_Width;?>" id="Rich_Web_VS_SL_Width" name="Rich_Web_VS_SL_Width" min="200" max="1200">
							<span class="range-slider__value" id="Rich_Web_VS_SL_Width_1">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS1[0]->Rich_Web_VS_SL_Height;?>" id="Rich_Web_VS_SL_Height" name="Rich_Web_VS_SL_Height" min="200" max="1200">
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS1[0]->Rich_Web_VS_CP_NO;?>" id="Rich_Web_VS_CP_NO" id="Rich_Web_VS_CP_NO" name="Rich_Web_VS_CP_NO" min="0" max="100">
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS1[0]->Rich_Web_VS_CP_CapS;?>" id="Rich_Web_VS_CP_CapS" name="Rich_Web_VS_CP_CapS" min="100" max="1000" step="100">
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS1[0]->Rich_Web_VS_CP_CapO;?>" id="Rich_Web_VS_CP_CapO" name="Rich_Web_VS_CP_CapO" min="0" max="100">
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS1[0]->Rich_Web_VS_CP_TFS;?>" id="Rich_Web_VS_CP_TFS" name="Rich_Web_VS_CP_TFS" min="8" max="48">
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_CS_TBgC" value="<?= $Rich_Web_VS1[0]->Rich_Web_VS_CS_TBgC;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_CS_TC" value="<?= $Rich_Web_VS1[0]->Rich_Web_VS_CS_TC;?>"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="Rich_Web_VS_CS_DBgC" id="Rich_Web_VS_CS_DBgC" value="<?= $Rich_Web_VS1[0]->Rich_Web_VS_CS_DBgC;?>"/>
					</td>
					<td colspan="3"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_CS_TiBgC" value="<?= $Rich_Web_VS1[0]->Rich_Web_VS_CS_TiBgC;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_CS_TiC" value="<?= $Rich_Web_VS1[0]->Rich_Web_VS_CS_TiC;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS1[0]->Rich_Web_VS_CP_TiO;?>" id="Rich_Web_VS_CP_TiO" name="Rich_Web_VS_CP_TiO" min="0" max="100">
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS1[0]->Rich_Web_VS_CP_TiD;?>" id="Rich_Web_VS_CP_TiD" name="Rich_Web_VS_CP_TiD" min="10" max="40">
							<span class="range-slider__value" id="Rich_Web_VS_CP_TiD_1">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS1[0]->Rich_Web_VS_CP_TiP;?>" id="Rich_Web_VS_CP_TiP" name="Rich_Web_VS_CP_TiP" min="0" max="10">
							<span class="range-slider__value" id="Rich_Web_VS_CP_TiP_1">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS1[0]->Rich_Web_VS_CP_TiS;?>" id="Rich_Web_VS_CP_TiS" name="Rich_Web_VS_CP_TiS" min="1" max="10">
							<span class="range-slider__value" id="Rich_Web_VS_CP_TiS_1">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS1[0]->Rich_Web_VS_CP_TiBS;?>" id="Rich_Web_VS_CP_TiBS" name="Rich_Web_VS_CP_TiBS" min="1" max="10">
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_CP_TiBC" value="<?= $Rich_Web_VS1[0]->Rich_Web_VS_CP_TiBC;?>"/>
					</td>
					<td>
				...
				<tr>
					...
					<td>
						<input type="text" name="Rich_Web_VS_ContSl_L_BgC" id="Rich_Web_VS_ContSl_L_BgC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS1_Loader[0]->Rich_Web_VS_ContSl_L_BgC;?>">
					</td>
				</tr>
				<tr>
					<td>Text Color</td>
				...
				<tr>
					<td>
						<input type="text" name="Rich_Web_VS_ContSl_LT_C" id="Rich_Web_VS_ContSl_LT_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS1_Loader[0]->Rich_Web_VS_ContSl_LT_C;?>">
					</td>
					<td>
						<input type="text" name="Rich_Web_VS_ContSl_L_C" id="Rich_Web_VS_ContSl_L_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS1_Loader[0]->Rich_Web_VS_ContSl_L_C;?>">
					</td>
					<td>
					...
					<td>
						<input type="text" name="Rich_Web_VS_ContSl_LT" id="Rich_Web_VS_ContSl_LT" value="<?= $Rich_Web_VS1_Loader[0]->Rich_Web_VS_ContSl_LT;?>">
					</td>
				</tr>
				<tr>
					<td>Loader Type</td>
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS1_Loader[0]->Rich_Web_VS_ContSl_LT_FS;?>" id="Rich_Web_VS_ContSl_LT_FS" name="Rich_Web_VS_ContSl_LT_FS" min="8" max="25">
				...
				<tr class="Loder_1_Option">
					<td>
						<input type="text" name="Rich_Web_VS_ContSl_L_T1_C" id="Rich_Web_VS_ContSl_L_T1_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS1_Loader[0]->Rich_Web_VS_ContSl_L_T1_C;?>">
					</td>
					<td>
						<input type="text" name="Rich_Web_VS_ContSl_L_T2_C" id="Rich_Web_VS_ContSl_L_T2_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS1_Loader[0]->Rich_Web_VS_ContSl_L_T2_C;?>">
					</td>
					<td>
						<input type="text" name="Rich_Web_VS_ContSl_L_T3_C" id="Rich_Web_VS_ContSl_L_T3_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS1_Loader[0]->Rich_Web_VS_ContSl_L_T3_C;?>">
					</td>
					<td></td>
				</tr>
				...
				<tr class="rw_text_color rw_text_color1">
					<td>
						<input type="text" name="Rich_Web_VS_ContSl_LT_T2_BC" id="Rich_Web_VS_ContSl_LT_T2_BC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS1_Loader[0]->Rich_Web_VS_ContSl_LT_T2_BC;?>">
					</td>
					<td colspan="3"></td>
				</tr>
				...
				<tr class="rw_text_color rw_text_color2">
					<td>
						<input type="text" name="Rich_Web_VS_ContSl_LT_T2_AnC" id="Rich_Web_VS_ContSl_LT_T2_AnC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS1_Loader[0]->Rich_Web_VS_ContSl_LT_T2_AnC;?>">
					</td>
					<td colspan="3"></td>
				</tr>
				...
				<tr class="rw_text_color rw_text_color3">
					<td>
						<input type="text" name="Rich_Web_VS_ContSl_LT_T3_BgC" id="Rich_Web_VS_ContSl_LT_T3_BgC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS1_Loader[0]->Rich_Web_VS_ContSl_LT_T3_BgC;?>">
					</td>
					<td colspan="3"></td>
				</tr>
			</table>
			<table class='Rich_Web_VSlider_Save_Table_2 RWeb_VSlider_Save_Table_2' id="Rich_Web_VSlider_Save_Table_2_2">
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS2[0]->Rich_Web_VS_SS_ED;?>" id="Rich_Web_VS_SS_ED" name="Rich_Web_VS_SS_ED" min="1" max="10">
							<span class="range-slider__value" id="Rich_Web_VS_SS_ED_1">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS2[0]->Rich_Web_VS_SS_PT;?>" id="Rich_Web_VS_SS_PT" id="Rich_Web_VS_SS_PT" name="Rich_Web_VS_SS_PT" min="100" max="1000" step="100">
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS2[0]->Rich_Web_VS_SS_W;?>" id="Rich_Web_VS_SS_W" name="Rich_Web_VS_SS_W" min="150" max="1200">
							<span class="range-slider__value" id="Rich_Web_VS_SS_W_1">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS2[0]->Rich_Web_VS_SS_H;?>" id="Rich_Web_VS_SS_H" name="Rich_Web_VS_SS_H" min="150" max="1200">
							<span class="range-slider__value" id="Rich_Web_VS_SS_H_1">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS2[0]->Rich_Web_VS_SS_BW;?>" id="Rich_Web_VS_SS_BW" name="Rich_Web_VS_SS_BW" min="0" max="10">
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_SS_BC" value="<?= $Rich_Web_VS2[0]->Rich_Web_VS_SS_BC;?>"/>
					</td>
					<td colspan="3"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS2[0]->Rich_Web_VS_SS_TFS;?>" id="Rich_Web_VS_SS_TFS" name="Rich_Web_VS_SS_TFS" min="8" max="48">
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_SS_TC" value="<?= $Rich_Web_VS2[0]->Rich_Web_VS_SS_TC;?>"/>
					</td>
				</tr>
				<tr>
					<td>Background Color <span class="Rich_Web_VSlider_Pro"> (Pro) </span></td>
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_SS_TBgC" value="<?= $Rich_Web_VS2[0]->Rich_Web_VS_SS_TBgC;?>"/>
					</td>
					<td>
				...
				<tr>
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_SS_NC" value="<?= $Rich_Web_VS2[0]->Rich_Web_VS_SS_NC;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_SS_NBgC" value="<?= $Rich_Web_VS2[0]->Rich_Web_VS_SS_NBgC;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS2[0]->Rich_Web_VS_SS_NS;?>" id="Rich_Web_VS_SS_NS" name="Rich_Web_VS_SS_NS" min="8" max="48">
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS2[0]->Rich_Web_VS_SS_PagW;?>" id="Rich_Web_VS_SS_PagW" name="Rich_Web_VS_SS_PagW" min="1" max="15">
							<span class="range-slider__value" id="Rich_Web_VS_SS_PagW_1">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS2[0]->Rich_Web_VS_SS_PagH;?>" id="Rich_Web_VS_SS_PagH" name="Rich_Web_VS_SS_PagH" min="1" max="15">
							<span class="range-slider__value" id="Rich_Web_VS_SS_PagH_1">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS2[0]->Rich_Web_VS_SS_PagPB;?>" id="Rich_Web_VS_SS_PagPB" name="Rich_Web_VS_SS_PagPB" min="0" max="10">
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_SS_PagBgC" value="<?= $Rich_Web_VS2[0]->Rich_Web_VS_SS_PagBgC;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS2[0]->Rich_Web_VS_SS_PagBW;?>" id="Rich_Web_VS_SS_PagBW" name="Rich_Web_VS_SS_PagBW" min="0" max="5">
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS2[0]->Rich_Web_VS_SS_PagBR;?>" id="Rich_Web_VS_SS_PagBR" name="Rich_Web_VS_SS_PagBR" min="0" max="20">
							<span class="range-slider__value" id="Rich_Web_VS_SS_PagBR_1">0</span>
						</div>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_SS_PagHC" value="<?= $Rich_Web_VS2[0]->Rich_Web_VS_SS_PagHC;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_SS_PagCC" value="<?= $Rich_Web_VS2[0]->Rich_Web_VS_SS_PagCC;?>"/>
					</td>
					<td>
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_SS_PIBgC" value="<?= $Rich_Web_VS2[0]->Rich_Web_VS_SS_PIBgC;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_SS_PIC" value="<?= $Rich_Web_VS2[0]->Rich_Web_VS_SS_PIC;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_SS_PIHBgC" value="<?= $Rich_Web_VS2[0]->Rich_Web_VS_SS_PIHBgC;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_SS_PIHC" value="<?= $Rich_Web_VS2[0]->Rich_Web_VS_SS_PIHC;?>"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_SS_CIBgC" value="<?= $Rich_Web_VS2[0]->Rich_Web_VS_SS_CIBgC;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_SS_CIC" value="<?= $Rich_Web_VS2[0]->Rich_Web_VS_SS_CIC;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_SS_CIHBgC" value="<?= $Rich_Web_VS2[0]->Rich_Web_VS_SS_CIHBgC;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_SS_CIHC" value="<?= $Rich_Web_VS2[0]->Rich_Web_VS_SS_CIHC;?>"/>
					</td>
				</tr>
				<tr>
					<td colspan="4">Loading Options</td>
				...
				<tr>
					...
					<td>
						<input type="text" name="Rich_Web_SlickSl_L_BgC" id="Rich_Web_SlickSl_L_BgC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS2_Loader[0]->Rich_Web_SlickSl_L_BgC;?>">
					</td>
				</tr>
				<tr>
					<td>Text Color</td>
				...
				<tr>
					<td>
						<input type="text" name="Rich_Web_SlickSl_LT_C" id="Rich_Web_SlickSl_LT_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS2_Loader[0]->Rich_Web_SlickSl_LT_C;?>">
					</td>
					<td>
						<input type="text" name="Rich_Web_SlickSl_L_C" id="Rich_Web_SlickSl_L_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS2_Loader[0]->Rich_Web_SlickSl_L_C;?>">
					</td>
					<td>
					...
					<td>
						<input type="text" name="Rich_Web_SlickSl_LT" id="Rich_Web_SlickSl_LT" value="<?= $Rich_Web_VS2_Loader[0]->Rich_Web_SlickSl_LT;?>">
					</td>
				</tr>
				<tr>
					<td>Loader Type</td>
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS2_Loader[0]->Rich_Web_SlickSl_LT_FS;?>" id="Rich_Web_SlickSl_LT_FS" name="Rich_Web_SlickSl_LT_FS" min="8" max="25">
				...
				<tr class="Loder_1_Option">
					<td>
						<input type="text" name="Rich_Web_SlickSl_L_T1_C" id="Rich_Web_SlickSl_L_T1_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS2_Loader[0]->Rich_Web_SlickSl_L_T1_C;?>">
					</td>
					<td>
						<input type="text" name="Rich_Web_SlickSl_L_T2_C" id="Rich_Web_SlickSl_L_T2_C" class="Rich_Web_VS_Color" value="
						<?= $Rich_Web_VS2_Loader[0]->Rich_Web_SlickSl_L_T2_C;?>">
					</td>
					<td>
						<input type="text" name="Rich_Web_SlickSl_L_T3_C" id="Rich_Web_SlickSl_L_T3_C" class="Rich_Web_VS_Color" value="
						<?= $Rich_Web_VS2_Loader[0]->Rich_Web_SlickSl_L_T3_C;?>">
					</td>
					<td></td>
				</tr>
				<tr class="rw_text_color rw_text_color1">
				...
				<tr class="rw_text_color rw_text_color1">
					<td>
						<input type="text" name="Rich_Web_SlickSl_LT_T2_BC" id="Rich_Web_SlickSl_LT_T2_BC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS2_Loader[0]->Rich_Web_SlickSl_LT_T2_BC;?>">
					</td>
					<td colspan="3"></td>
				</tr>
				<tr class="rw_text_color rw_text_color2">
				...
				<tr class="rw_text_color rw_text_color2">
					<td>
						<input type="text" name="Rich_Web_SlickSl_LT_T2_AnC" id="Rich_Web_SlickSl_LT_T2_AnC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS2_Loader[0]->Rich_Web_SlickSl_LT_T2_AnC;?>">
					</td>
					<td colspan="3"></td>
				</tr>
				<tr class="rw_text_color rw_text_color3">
				...
				<tr class="rw_text_color rw_text_color3">
					<td>
						<input type="text" name="Rich_Web_SlickSl_LT_T3_BgC" id="Rich_Web_SlickSl_LT_T3_BgC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS2_Loader[0]->Rich_Web_SlickSl_LT_T3_BgC;?>">
					</td>
					<td colspan="3"></td>
				</tr>
			</table>
			<table class='Rich_Web_VSlider_Save_Table_2 RWeb_VSlider_Save_Table_2' id="Rich_Web_VSlider_Save_Table_2_3">
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS3[0]->Rich_Web_VS_TS_W;?>" id="Rich_Web_VS_TS_W" name="Rich_Web_VS_TS_W" min="150" max="1200">
							<span class="range-slider__value" id="Rich_Web_VS_TS_W_1">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS3[0]->Rich_Web_VS_TS_H;?>" id="Rich_Web_VS_TS_H" name="Rich_Web_VS_TS_H" min="150" max="1200">
							<span class="range-slider__value" id="Rich_Web_VS_TS_H_1">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS3[0]->Rich_Web_VS_TS_BW;?>" id="Rich_Web_VS_TS_BW" name="Rich_Web_VS_TS_BW" min="0" max="10">
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_TS_BC" value="<?= $Rich_Web_VS3[0]->Rich_Web_VS_TS_BC;?>"/>
					</td>
					<td>
						<label class="switch switch-light">
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS3[0]->Rich_Web_VS_TS_BoxShC;?>" id="Rich_Web_VS_TS_BoxSh" name="Rich_Web_VS_TS_BoxSh" min="0" max="30">
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_TS_BoxShC" value="<?= $Rich_Web_VS3[0]->Rich_Web_VS_TS_BoxShC;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS3[0]->Rich_Web_VS_TS_CS;?>" id="Rich_Web_VS_TS_CS" name="Rich_Web_VS_TS_CS" min="100" max="1000" step="100">
							<span class="range-slider__value" id="Rich_Web_VS_TS_CS_1">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS3[0]->Rich_Web_VS_TS_PT;?>" id="Rich_Web_VS_TS_PT" name="Rich_Web_VS_TS_PT" min="1" max="15">
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_TS_IBgC" value="<?= $Rich_Web_VS3[0]->Rich_Web_VS_TS_IBgC;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS3[0]->Rich_Web_VS_TS_IBW;?>" id="Rich_Web_VS_TS_IBW" name="Rich_Web_VS_TS_IBW" min="0" max="3">
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_TS_IBC" value="<?= $Rich_Web_VS3[0]->Rich_Web_VS_TS_IBC;?>"/>
					</td>
				</tr>
				<tr>
					<td>Border Radius (px)</td>
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS3[0]->Rich_Web_VS_TS_IBR;?>" id="Rich_Web_VS_TS_IBR" name="Rich_Web_VS_TS_IBR" min="0" max="20">
				...
				<tr>
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_TS_TBgC" value="<?= $Rich_Web_VS3[0]->Rich_Web_VS_TS_TBgC;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS3[0]->Rich_Web_VS_TS_TBW;?>" id="Rich_Web_VS_TS_TBW" name="Rich_Web_VS_TS_TBW" min="0" max="5">
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_TS_TBC" value="<?= $Rich_Web_VS3[0]->Rich_Web_VS_TS_TBC;?>"/>
					</td>
					<td colspan="3"></td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS3[0]->Rich_Web_VS_TS_TIH;?>" id="Rich_Web_VS_TS_TIH" name="Rich_Web_VS_TS_TIH" min="50" max="150">
							<span class="range-slider__value" id="Rich_Web_VS_TS_TIH_1">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS3[0]->Rich_Web_VS_TS_TIPB;?>" id="Rich_Web_VS_TS_TIPB" name="Rich_Web_VS_TS_TIPB" min="0" max="15">
							<span class="range-slider__value" id="Rich_Web_VS_TS_TIPB_1">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS3[0]->Rich_Web_VS_TS_TIBW;?>" id="Rich_Web_VS_TS_TIBW" name="Rich_Web_VS_TS_TIBW" min="0" max="5">
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_TS_TIBC" value="<?= $Rich_Web_VS3[0]->Rich_Web_VS_TS_TIBC;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS3[0]->Rich_Web_VS_TS_TIBR;?>" id="Rich_Web_VS_TS_TIBR" name="Rich_Web_VS_TS_TIBR" min="0" max="150">
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS3[0]->Rich_Web_VS_TS_TIBoxSh;?>" id="Rich_Web_VS_TS_TIBoxSh" name="Rich_Web_VS_TS_TIBoxSh" min="0" max="30">
							<span class="range-slider__value" id="Rich_Web_VS_TS_TIBoxSh_1">0</span>
						</div>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_TS_TIBoxShC" value="<?= $Rich_Web_VS3[0]->Rich_Web_VS_TS_TIBoxShC;?>"/>
					</td>
					<td colspan="2"></td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_TS_TICBC" value="<?= $Rich_Web_VS3[0]->Rich_Web_VS_TS_TICBC;?>"/>
					</td>
					<td>
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_TS_TICBoxShC" value="<?= $Rich_Web_VS3[0]->Rich_Web_VS_TS_TICBoxShC;?>"/>
					</td>
					<td></td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_TS_TIHBC" value="<?= $Rich_Web_VS3[0]->Rich_Web_VS_TS_TIHBC;?>"/>
					</td>
					<td>
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_TS_TIHBoxShC" value="<?= $Rich_Web_VS3[0]->Rich_Web_VS_TS_TIHBoxShC;?>"/>
					</td>
					<td></td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_TS_PIBgC" value="<?= $Rich_Web_VS3[0]->Rich_Web_VS_TS_PIBgC;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_TS_PIC" value="<?= $Rich_Web_VS3[0]->Rich_Web_VS_TS_PIC;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_TS_PIHBgC" value="<?= $Rich_Web_VS3[0]->Rich_Web_VS_TS_PIHBgC;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_TS_PIHC" value="<?= $Rich_Web_VS3[0]->Rich_Web_VS_TS_PIHC;?>"/>
					</td>
				</tr>
				<tr>
					<td colspan="4">Loading Options</td>
				...
				<tr>
					...
					<td>
						<input type="text" name="Rich_Web_ThumbSl_L_BgC" id="Rich_Web_ThumbSl_L_BgC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS3_Loader[0]->Rich_Web_ThumbSl_L_BgC;?>">
					</td>
				</tr>
				<tr>
					<td>Text Color</td>
				...
				<tr>
					<td>
						<input type="text" name="Rich_Web_ThumbSl_LT_C" id="Rich_Web_ThumbSl_LT_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS3_Loader[0]->Rich_Web_ThumbSl_LT_C;?>">
					</td>
					<td>
						<input type="text" name="Rich_Web_ThumbSl_L_C" id="Rich_Web_ThumbSl_L_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS3_Loader[0]->Rich_Web_ThumbSl_L_C;?>">
					</td>
					<td>
					...
					<td>
						<input type="text" name="Rich_Web_ThumbSl_LT" id="Rich_Web_ThumbSl_LT" value="<?= $Rich_Web_VS3_Loader[0]->Rich_Web_ThumbSl_LT;?>">
					</td>
				</tr>
				<tr>
					<td>Loader Type</td>
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS3_Loader[0]->Rich_Web_ThumbSl_LT_FS;?>" id="Rich_Web_ThumbSl_LT_FS" name="Rich_Web_ThumbSl_LT_FS" min="8" max="25">
				...
				<tr class="Loder_1_Option">
					<td>
						<input type="text" name="Rich_Web_ThumbSl_L_T1_C" id="Rich_Web_ThumbSl_L_T1_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS3_Loader[0]->Rich_Web_ThumbSl_L_T1_C;?>">
					</td>
					<td>
						<input type="text" name="Rich_Web_ThumbSl_L_T2_C" id="Rich_Web_ThumbSl_L_T2_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS3_Loader[0]->Rich_Web_ThumbSl_L_T2_C;?>">
					</td>
					<td>
						<input type="text" name="Rich_Web_ThumbSl_L_T3_C" id="Rich_Web_ThumbSl_L_T3_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS3_Loader[0]->Rich_Web_ThumbSl_L_T3_C;?>">
					</td>
					<td></td>
				</tr>
				<tr class="rw_text_color rw_text_color1">
				...
				<tr class="rw_text_color rw_text_color1">
					<td>
						<input type="text" name="Rich_Web_ThumbSl_LT_T2_BC" id="Rich_Web_ThumbSl_LT_T2_BC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS3_Loader[0]->Rich_Web_ThumbSl_LT_T2_BC;?>">
					</td>
					<td colspan="3"></td>
				</tr>
				<tr class="rw_text_color rw_text_color2">
				...
				<tr class="rw_text_color rw_text_color2">
					<td>
						<input type="text" name="Rich_Web_ThumbSl_LT_T2_AnC" id="Rich_Web_ThumbSl_LT_T2_AnC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS3_Loader[0]->Rich_Web_ThumbSl_LT_T2_AnC;?>">
					</td>
					<td colspan="3"></td>
				</tr>
				<tr class="rw_text_color rw_text_color3">
				...
				<tr class="rw_text_color rw_text_color3">
					<td>
						<input type="text" name="Rich_Web_ThumbSl_LT_T3_BgC" id="Rich_Web_ThumbSl_LT_T3_BgC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS3_Loader[0]->Rich_Web_ThumbSl_LT_T3_BgC;?>">
					</td>
					<td colspan="3"></td>
				</tr>
			</table>
			<table class='Rich_Web_VSlider_Save_Table_2 RWeb_VSlider_Save_Table_2' id="Rich_Web_VSlider_Save_Table_2_4">
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VC_Car_Bg_Color" value="<?= $Rich_Web_VS4[0]->Rich_Web_VC_Car_Bg_Color;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS4[0]->Rich_Web_VC_Car_Border_Width;?>" id="Rich_Web_VC_Car_Border_Width" name="Rich_Web_VC_Car_Border_Width" min="0" max="5">
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VC_Car_Border_Color" value="<?= $Rich_Web_VS4[0]->Rich_Web_VC_Car_Border_Color;?>"/>
					</td>
				</tr>
				<tr>
					<td>Box Shadow (px)</td>
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS4[0]->Rich_Web_VC_Car_Box_Shadow;?>" id="Rich_Web_VC_Car_Box_Shadow" name="Rich_Web_VC_Car_Box_Shadow" min="0" max="50">
							<span class="range-slider__value" id="Rich_Web_VC_Car_Box_Shadow_1">0</span>
						</div>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VC_Car_Shadow_Color" value="<?= $Rich_Web_VS4[0]->Rich_Web_VC_Car_Shadow_Color;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS4[0]->Rich_Web_VC_Car_Count_Imgs;?>" id="Rich_Web_VC_Car_Count_Imgs" name="Rich_Web_VC_Car_Count_Imgs" min="2" max="8">
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS4[0]->Rich_Web_VC_Car_PBImgs;?>" id="Rich_Web_VC_Car_PBImgs" name="Rich_Web_VC_Car_PBImgs" min="0" max="10">
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS4[0]->Rich_Web_VC_Car_Icons_Size;?>" id="Rich_Web_VC_Car_Icons_Size" name="Rich_Web_VC_Car_Icons_Size" min="0" max="50">
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VC_Overlay_Bg_Color" value="<?= $Rich_Web_VS4[0]->Rich_Web_VC_Overlay_Bg_Color;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VC_Popup_Bg_Color" value="<?= $Rich_Web_VS4[0]->Rich_Web_VC_Popup_Bg_Color;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS4[0]->Rich_Web_VC_Popup_Border_Width;?>" id="Rich_Web_VC_Popup_Border_Width" name="Rich_Web_VC_Popup_Border_Width" min="0" max="20">
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VC_Popup_Border_Color" value="<?= $Rich_Web_VS4[0]->Rich_Web_VC_Popup_Border_Color;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS4[0]->Rich_Web_VC_Popup_Box_Shadow;?>" id="Rich_Web_VC_Popup_Box_Shadow" name="Rich_Web_VC_Popup_Box_Shadow" min="0" max="50">
							<span class="range-slider__value" id="Rich_Web_VC_Popup_Box_Shadow_1">0</span>
						</div>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VC_Popup_Shadow_Color" value="<?= $Rich_Web_VS4[0]->Rich_Web_VC_Popup_Shadow_Color;?>"/>
					</td>
					<td></td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS4[0]->Rich_Web_VC_Title_Font_Size;?>" id="Rich_Web_VC_Title_Font_Size" name="Rich_Web_VC_Title_Font_Size" min="10" max="36">
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VC_Title_Color" value="<?= $Rich_Web_VS4[0]->Rich_Web_VC_Title_Color;?>"/>
					</td>
					<td>
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VC_Desc_Bg_Color" value="<?= $Rich_Web_VS4[0]->Rich_Web_VC_Desc_Bg_Color;?>"/>
					</td>
					<td colspan="3"></td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS4[0]->Rich_Web_VC_Link_Font_Size;?>" id="Rich_Web_VC_Link_Font_Size" name="Rich_Web_VC_Link_Font_Size" min="10" max="36">
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VC_Link_Color" value="<?= $Rich_Web_VS4[0]->Rich_Web_VC_Link_Color;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VC_Link_Bg_Color" value="<?= $Rich_Web_VS4[0]->Rich_Web_VC_Link_Bg_Color;?>"/>
					</td>
				</tr>
				<tr>
					<td>Border Color <span class="Rich_Web_VSlider_Pro"> (Pro) </span></td>
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VC_Link_Border_Color" value="<?= $Rich_Web_VS4[0]->Rich_Web_VC_Link_Border_Color;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS4[0]->Rich_Web_VC_Link_Border_Width;?>" id="Rich_Web_VC_Link_Border_Width" name="Rich_Web_VC_Link_Border_Width" min="0" max="5">
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VC_Link_Hov_Bg_Color" value="<?= $Rich_Web_VS4[0]->Rich_Web_VC_Link_Hov_Bg_Color;?>"/>
					</td>
				</tr>
				<tr>
					<td>Hover Color <span class="Rich_Web_VSlider_Pro"> (Pro) </span></td>
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VC_Link_Hov_Color" value="<?= $Rich_Web_VS4[0]->Rich_Web_VC_Link_Hov_Color;?>"/>
					</td>
					<td>
					...
					<td>
						<input type="text" name="Rich_Web_VC_Link_Text" id="Rich_Web_VC_Link_Text" value="<?= $Rich_Web_VS4[0]->Rich_Web_VC_Link_Text;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS4[0]->Rich_Web_VC_Link_Border_Radius;?>" id="Rich_Web_VC_Link_Border_Radius" name="Rich_Web_VC_Link_Border_Radius" min="0" max="10">
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS4[0]->Rich_Web_VC_Popup_Icons_Size;?>" id="Rich_Web_VC_Popup_Icons_Size" name="Rich_Web_VC_Popup_Icons_Size" min="15" max="50">
							<span class="range-slider__value" id="Rich_Web_VC_Popup_Icons_Size_1">0</span>
						</div>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VC_Popup_Icons_Color" value="<?= $Rich_Web_VS4[0]->Rich_Web_VC_Popup_Icons_Color;?>"/>
					</td>
					<td>
				...
				<tr>
					...
					<td>
						<input type="text" name="Rich_Web_VCCP_L_BgC" id="Rich_Web_VCCP_L_BgC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS4_Loader[0]->Rich_Web_VCCP_L_BgC;?>">
					</td>
				</tr>
				<tr>
					<td>Text Color</td>
				...
				<tr>
					<td>
						<input type="text" name="Rich_Web_VCCP_LT_C" id="Rich_Web_VCCP_LT_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS4_Loader[0]->Rich_Web_VCCP_LT_C;?>">
					</td>
					<td>
						<input type="text" name="Rich_Web_VCCP_L_C" id="Rich_Web_VCCP_L_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS4_Loader[0]->Rich_Web_VCCP_L_C;?>">
					</td>
					<td>
					...
					<td>
						<input type="text" name="Rich_Web_VCCP_LT" id="Rich_Web_VCCP_LT" value="<?= $Rich_Web_VS4_Loader[0]->Rich_Web_VCCP_LT;?>">
					</td>
				</tr>
				<tr>
					<td>Loader Type</td>
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS4_Loader[0]->Rich_Web_VCCP_LT_FS;?>" id="Rich_Web_VCCP_LT_FS" id="Rich_Web_VCCP_LT_FS" name="Rich_Web_VCCP_LT_FS" min="8" max="25">
				...
				<tr class="Loder_1_Option">
					<td>
						<input type="text" name="Rich_Web_VCCP_L_T1_C" id="Rich_Web_VCCP_L_T1_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS4_Loader[0]->Rich_Web_VCCP_L_T1_C;?>">
					</td>
					<td>
						<input type="text" name="Rich_Web_VCCP_L_T2_C" id="Rich_Web_VCCP_L_T2_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS4_Loader[0]->Rich_Web_VCCP_L_T2_C;?>">
					</td>
					<td>
						<input type="text" name="Rich_Web_VCCP_L_T3_C" id="Rich_Web_VCCP_L_T3_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS4_Loader[0]->Rich_Web_VCCP_L_T3_C;?>">
					</td>
					<td></td>
				</tr>
				<tr class="rw_text_color rw_text_color1">
				...
				<tr class="rw_text_color rw_text_color1">
					<td>
						<input type="text" name="Rich_Web_VCCP_LT_T2_BC" id="Rich_Web_VCCP_LT_T2_BC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS4_Loader[0]->Rich_Web_VCCP_LT_T2_BC;?>">
					</td>
					<td colspan="3"></td>
				</tr>
				<tr class="rw_text_color rw_text_color2">
				...
				<tr class="rw_text_color rw_text_color2">
					<td>
						<input type="text" name="Rich_Web_VCCP_LT_T2_AnC" id="Rich_Web_VCCP_LT_T2_AnC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS4_Loader[0]->Rich_Web_VCCP_LT_T2_AnC;?>">
					</td>
					<td colspan="3"></td>
				</tr>
				<tr class="rw_text_color rw_text_color3">
				...
				<tr class="rw_text_color rw_text_color3">
					<td>
						<input type="text" name="Rich_Web_VCCP_LT_T3_BgC" id="Rich_Web_VCCP_LT_T3_BgC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS4_Loader[0]->Rich_Web_VCCP_LT_T3_BgC;?>">
					</td>
					<td colspan="3"></td>
				</tr>
			</table>
			<table class='Rich_Web_VSlider_Save_Table_2 RWeb_VSlider_Save_Table_2' id="Rich_Web_VSlider_Save_Table_2_5">
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_W;?>" id="Rich_Web_SVS_W" name="Rich_Web_SVS_W" min="300" max="1200">
							<span class="range-slider__value" id="Rich_Web_SVS_W_1">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_PT;?>" id="Rich_Web_SVS_PT" name="Rich_Web_SVS_PT" min="1" max="15">
							<span class="range-slider__value" id="Rich_Web_SVS_PT_1">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_CS;?>" id="Rich_Web_SVS_CS" name="Rich_Web_SVS_CS" min="100" max="1500" step="100">
							<span class="range-slider__value" id="Rich_Web_SVS_CS_1">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_BW;?>" id="Rich_Web_SVS_BW" name="Rich_Web_SVS_BW" min="0" max="15">
				...
				<tr>
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_SVS_BC" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_BC;?>"/>
					</td>
					<td>
						<label class="switch switch-light">
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_BoxSh;?>" id="Rich_Web_SVS_BoxSh" name="Rich_Web_SVS_BoxSh" min="0" max="50">
							<span class="range-slider__value" id="Rich_Web_SVS_BoxSh_1">0</span>
						</div>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_SVS_BoxShC" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_BoxShC;?>"/>
					</td>
					<td>
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_Nav_W;?>" id="Rich_Web_SVS_Nav_W" name="Rich_Web_SVS_Nav_W" min="0" max="20">
							<span class="range-slider__value" id="Rich_Web_SVS_Nav_W_1">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_Nav_H;?>" id="Rich_Web_SVS_Nav_H" name="Rich_Web_SVS_Nav_H" min="0" max="20">
							<span class="range-slider__value" id="Rich_Web_SVS_Nav_H_1">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_Nav_BW;?>" id="Rich_Web_SVS_Nav_BW" name="Rich_Web_SVS_Nav_BW" min="0" max="5">
				...
				<tr>
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_SVS_Nav_BC" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_Nav_BC;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_Nav_BR;?>" id="Rich_Web_SVS_Nav_BR" name="Rich_Web_SVS_Nav_BR" min="0" max="30">
							<span class="range-slider__value" id="Rich_Web_SVS_Nav_BR_1">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_Nav_PB;?>" id="Rich_Web_SVS_Nav_PB" name="Rich_Web_SVS_Nav_PB" min="0" max="10">
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_SVS_Nav_C" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_Nav_C;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_SVS_Nav_CC" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_Nav_CC;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_SVS_Nav_HC" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_Nav_HC;?>"/>
					</td>
					<td>
				...
				<tr>
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_SVS_TBgC" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_TBgC;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_SVS_TC" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_TC;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_TFS;?>" id="Rich_Web_SVS_TFS" name="Rich_Web_SVS_TFS" min="8" max="48">
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_SVS_LC" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_LC;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_LFS;?>" id="Rich_Web_SVS_LFS" name="Rich_Web_SVS_LFS" min="8" max="48">
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_SVS_LHC" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_LHC;?>"/>
					</td>
				</tr>
				<tr>
					<td>Text</td>
				...
				<tr>
					<td>
						<input type="text" name="Rich_Web_SVS_LText" id="Rich_Web_SVS_LText" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_LText;?>"/>
					</td>
					<td colspan="3"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_Arr_S;?>" id="Rich_Web_SVS_Arr_S" name="Rich_Web_SVS_Arr_S" min="8" max="48">
							<span class="range-slider__value" id="Rich_Web_SVS_Arr_S_1">0</span>
						</div>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_SVS_Arr_C" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_Arr_C;?>"/>
					</td>
				</tr>
				<tr>
					<td>Background Color <span class="Rich_Web_VSlider_Pro"> (Pro) </span></td>
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_SVS_Arr_BgC" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_Arr_BgC;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_Arr_BW;?>" id="Rich_Web_SVS_Arr_BW" name="Rich_Web_SVS_Arr_BW" min="0" max="5">
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_SVS_Arr_BC" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_Arr_BC;?>"/>
					</td>
				</tr>
				<tr>
					<td>Border Radius (px)</td>
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_Arr_BR;?>" id="Rich_Web_SVS_Arr_BR" name="Rich_Web_SVS_Arr_BR" min="0" max="100">
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_SVS_PIC" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_PIC;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_SVS_PIBgC" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_PIBgC;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_PIBR;?>" id="Rich_Web_SVS_PIBR" name="Rich_Web_SVS_PIBR" min="0" max="30">
							<span class="range-slider__value" id="Rich_Web_SVS_PIBR_1">0</span>
						</div>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_SVS_PIHC" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_PIHC;?>"/>
					</td>
				</tr>
				<tr>
					<td>Hover Background Color <span class="Rich_Web_VSlider_Pro"> (Pro) </span></td>
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_SVS_PIHBgC" value="<?= $Rich_Web_VS5[0]->Rich_Web_SVS_PIHBgC;?>"/>
					</td>
					<td colspan="3"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="Rich_Web_SimpleVS_L_BgC" id="Rich_Web_SimpleVS_L_BgC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS5_Loader[0]->Rich_Web_SimpleVS_L_BgC;?>">
					</td>
				</tr>
				<tr>
					<td>Text Color</td>
				...
				<tr>
					<td>
						<input type="text" name="Rich_Web_SimpleVS_LT_C" id="Rich_Web_SimpleVS_LT_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS5_Loader[0]->Rich_Web_SimpleVS_LT_C;?>">
					</td>
					<td>
						<input type="text" name="Rich_Web_SimpleVS_L_C" id="Rich_Web_SimpleVS_L_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS5_Loader[0]->Rich_Web_SimpleVS_L_C;?>">
					</td>
					<td>
					...
					<td>
						<input type="text" name="Rich_Web_SimpleVS_LT" id="Rich_Web_SimpleVS_LT" value="<?= $Rich_Web_VS5_Loader[0]->Rich_Web_SimpleVS_LT;?>">
					</td>
				</tr>
				<tr>
					<td>Loader Type</td>
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS5_Loader[0]->Rich_Web_SimpleVS_LT_FS;?>" id="Rich_Web_SimpleVS_LT_FS" name="Rich_Web_SimpleVS_LT_FS" min="8" max="25">
				...
				<tr class="Loder_1_Option">
					<td>
						<input type="text" name="Rich_Web_SimpleVS_L_T1_C" id="Rich_Web_SimpleVS_L_T1_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS5_Loader[0]->Rich_Web_SimpleVS_L_T1_C;?>">
					</td>
					<td>
						<input type="text" name="Rich_Web_SimpleVS_L_T2_C" id="Rich_Web_SimpleVS_L_T2_C" class="Rich_Web_VS_Color" value="
						<?= $Rich_Web_VS5_Loader[0]->Rich_Web_SimpleVS_L_T2_C;?>">
					</td>
					<td>
						<input type="text" name="Rich_Web_SimpleVS_L_T3_C" id="Rich_Web_SimpleVS_L_T3_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS5_Loader[0]->Rich_Web_SimpleVS_L_T3_C;?>">
					</td>
					<td></td>
				</tr>
				<tr class="rw_text_color rw_text_color1">
				...
				<tr class="rw_text_color rw_text_color1">
					<td>
						<input type="text" name="Rich_Web_SimpleVS_LT_T2_BC" id="Rich_Web_SimpleVS_LT_T2_BC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS5_Loader[0]->Rich_Web_SimpleVS_LT_T2_BC;?>">
					</td>
					<td colspan="3"></td>
				</tr>
				<tr class="rw_text_color rw_text_color2">
				...
				<tr class="rw_text_color rw_text_color2">
					<td>
						<input type="text" name="Rich_Web_SimpleVS_LT_T2_AnC" id="Rich_Web_SimpleVS_LT_T2_AnC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS5_Loader[0]->Rich_Web_SimpleVS_LT_T2_AnC;?>">
					</td>
					<td colspan="3"></td>
				</tr>
				<tr class="rw_text_color rw_text_color3">
				...
				<tr class="rw_text_color rw_text_color3">
					<td>
						<input type="text" name="Rich_Web_SimpleVS_LT_T3_BgC" id="Rich_Web_SimpleVS_LT_T3_BgC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS5_Loader[0]->Rich_Web_SimpleVS_LT_T3_BgC;?>">
					</td>
					<td colspan="3"></td>
				</tr>
			</table>
			<table class='Rich_Web_VSlider_Save_Table_2 RWeb_VSlider_Save_Table_2' id="Rich_Web_VSlider_Save_Table_2_6">
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS6[0]->Rich_Web_VTVS_APS;?>" id="Rich_Web_VTVS_APS" name="Rich_Web_VTVS_APS" min="1" max="5">
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS6[0]->Rich_Web_VTVS_CS;?>" id="Rich_Web_VTVS_CS" name="Rich_Web_VTVS_CS" min="100" max="2000" step="100">
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS6[0]->Rich_Web_VTVS_PT;?>" id="Rich_Web_VTVS_PT" name="Rich_Web_VTVS_PT" min="1" max="20">
							<span class="range-slider__value" id="Rich_Web_VTVS_PT_1">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS6[0]->Rich_Web_VTVS_ArrSt;?>" id="Rich_Web_VTVS_ArrSt" name="Rich_Web_VTVS_ArrSt" min="1" max="5">
							<span class="range-slider__value" id="Rich_Web_VTVS_ArrSt_1">0</span>
						</div>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VTVS_BgC" value="<?= $Rich_Web_VS6[0]->Rich_Web_VTVS_BgC;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS6[0]->Rich_Web_VTVS_H;?>" id="Rich_Web_VTVS_H" name="Rich_Web_VTVS_H" min="200" max="800">
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS6[0]->Rich_Web_VTVS_BW;?>" id="Rich_Web_VTVS_BW" name="Rich_Web_VTVS_BW" min="0" max="10">
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VTVS_BC" value="<?= $Rich_Web_VS6[0]->Rich_Web_VTVS_BC;?>"/>
					</td>
					<td>
						<label class="switch switch-light">
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS6[0]->Rich_Web_VTVS_BoxSh;?>" id="Rich_Web_VTVS_BoxSh" name="Rich_Web_VTVS_BoxSh" min="0" max="50">
							<span class="range-slider__value" id="Rich_Web_VTVS_BoxSh_1">0</span>
						</div>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VTVS_BoxShC" value="<?= $Rich_Web_VS6[0]->Rich_Web_VTVS_BoxShC;?>"/>
					</td>
					<td></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS6[0]->Rich_Web_VTVS_TFS;?>" id="Rich_Web_VTVS_TFS" name="Rich_Web_VTVS_TFS" min="8" max="48">
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VTVS_TC" value="<?= $Rich_Web_VS6[0]->Rich_Web_VTVS_TC;?>"/>
					</td>
				</tr>
				<tr>
					<td>Background Color <span class="Rich_Web_VSlider_Pro"> (Pro) </span></td>
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VTVS_TBgC" value="<?= $Rich_Web_VS6[0]->Rich_Web_VTVS_TBgC;?>/>
					</td>
					<td>
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS6[0]->Rich_Web_VTVS_Th_BW;?>" id="Rich_Web_VTVS_Th_BW" name="Rich_Web_VTVS_Th_BW" min="0" max="3">
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VTVS_Th_BC" value="<?= $Rich_Web_VS6[0]->Rich_Web_VTVS_Th_BC;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS6[0]->Rich_Web_VTVS_Th_BR;?>" id="Rich_Web_VTVS_Th_BR" name="Rich_Web_VTVS_Th_BR" min="0" max="20">
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VTVS_Th_HBC" value="<?= $Rich_Web_VS6[0]->Rich_Web_VTVS_Th_HBC;?>"/>
					</td>
					<td colspan="3"></td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VTVS_LC" value="<?= $Rich_Web_VS6[0]->Rich_Web_VTVS_LC;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VTVS_LBgC" value="<?= $Rich_Web_VS6[0]->Rich_Web_VTVS_LBgC;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS6[0]->Rich_Web_VTVS_LFS;?>" id="Rich_Web_VTVS_LFS" name="Rich_Web_VTVS_LFS" min="8" max="48">
							<span class="range-slider__value" id="Rich_Web_VTVS_LFS_1">0</span>
						</div>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VTVS_LHC" value="<?= $Rich_Web_VS6[0]->Rich_Web_VTVS_LHC;?>"/>
					</td>
				</tr>
				<tr>
					<td>Hover Background Color <span class="Rich_Web_VSlider_Pro"> (Pro) </span></td>
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VTVS_LHBgC" value="<?= $Rich_Web_VS6[0]->Rich_Web_VTVS_LHBgC;?>"/>
					</td>
					<td>
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VTVS_PC" value="<?= $Rich_Web_VS6[0]->Rich_Web_VTVS_PC;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VTVS_PBgC" value="<?= $Rich_Web_VS6[0]->Rich_Web_VTVS_PBgC;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS6[0]->Rich_Web_VTVS_PFS;?>" id="Rich_Web_VTVS_PFS" name="Rich_Web_VTVS_PFS" min="8" max="48">
							<span class="range-slider__value" id="Rich_Web_VTVS_PFS_1">0</span>
						</div>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VTVS_PHC" value="<?= $Rich_Web_VS6[0]->Rich_Web_VTVS_PHC;?>"/>
					</td>
				</tr>
				<tr>
					<td>Hover Background Color <span class="Rich_Web_VSlider_Pro"> (Pro) </span></td>
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VTVS_PHBgC" value="<?= $Rich_Web_VS6[0]->Rich_Web_VTVS_PHBgC;?>"/>
					</td>
					<td>
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS6[0]->Rich_Web_VTVS_ArrFS;?>" id="Rich_Web_VTVS_ArrFS" name="Rich_Web_VTVS_ArrFS" min="8" max="48">
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VTVS_ArrC" value="<?= $Rich_Web_VS6[0]->Rich_Web_VTVS_ArrC;?>"/>
					</td>
					<td colspan="3"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="Rich_Web_VSVT_L_BgC" id="Rich_Web_VSVT_L_BgC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS6_Loader[0]->Rich_Web_VSVT_L_BgC;?>">
					</td>
				</tr>
				<tr>
					<td>Text Color</td>
				...
				<tr>
					<td>
						<input type="text" name="Rich_Web_VSVT_LT_C" id="Rich_Web_VSVT_LT_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS6_Loader[0]->Rich_Web_VSVT_LT_C;?>">
					</td>
					<td>
						<input type="text" name="Rich_Web_VSVT_L_C" id="Rich_Web_VSVT_L_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS6_Loader[0]->Rich_Web_VSVT_L_C;?>">
					</td>
					<td>
					...
					<td>
						<input type="text" name="Rich_Web_VSVT_LT" id="Rich_Web_VSVT_LT" value="<?= $Rich_Web_VS6_Loader[0]->Rich_Web_VSVT_LT;?>">
					</td>
				</tr>
				<tr>
					<td>Loader Type</td>
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS6_Loader[0]->Rich_Web_VSVT_LT_FS;?>" id="Rich_Web_VSVT_LT_FS" name="Rich_Web_VSVT_LT_FS" min="8" max="25">
				...
				<tr class="Loder_1_Option">
					<td>
						<input type="text" name="Rich_Web_VSVT_L_T1_C" id="Rich_Web_VSVT_L_T1_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS6_Loader[0]->Rich_Web_VSVT_L_T1_C;?>">
					</td>
					<td>
						<input type="text" name="Rich_Web_VSVT_L_T2_C" id="Rich_Web_VSVT_L_T2_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS6_Loader[0]->Rich_Web_VSVT_L_T2_C;?>">
					</td>
					<td>
						<input type="text" name="Rich_Web_VSVT_L_T3_C" id="Rich_Web_VSVT_L_T3_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS6_Loader[0]->Rich_Web_VSVT_L_T3_C;?>">
					</td>
					<td></td>
				</tr>
				<tr class="rw_text_color rw_text_color1">
				...
				<tr class="rw_text_color rw_text_color1">
					<td>
						<input type="text" name="Rich_Web_VSVT_LT_T2_BC" id="Rich_Web_VSVT_LT_T2_BC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS6_Loader[0]->Rich_Web_VSVT_LT_T2_BC;?>">
					</td>
					<td colspan="3"></td>
				</tr>
				<tr class="rw_text_color rw_text_color2">
				...
				<tr class="rw_text_color rw_text_color2">
					<td>
						<input type="text" name="Rich_Web_VSVT_LT_T2_AnC" id="Rich_Web_VSVT_LT_T2_AnC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS6_Loader[0]->Rich_Web_VSVT_LT_T2_AnC;?>">
					</td>
					<td colspan="3"></td>
				</tr>
				<tr class="rw_text_color rw_text_color3">
				...
				<tr class="rw_text_color rw_text_color3">
					<td>
						<input type="text" name="Rich_Web_VSVT_LT_T3_BgC" id="Rich_Web_VSVT_LT_T3_BgC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS6_Loader[0]->Rich_Web_VSVT_LT_T3_BgC;?>">
					</td>
					<td colspan="3"></td>
				</tr>
			</table>
			<table class='Rich_Web_VSlider_Save_Table_2 RWeb_VSlider_Save_Table_2' id="Rich_Web_VSlider_Save_Table_2_7">
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_Cols;?>" id="Rich_Web_VS_HPS_Cols" name="Rich_Web_VS_HPS_Cols" min="1" max="10">
							<span class="range-slider__value" id="Rich_Web_VS_HPS_Cols_1">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_Speed;?>" id="Rich_Web_VS_HPS_Speed" name="Rich_Web_VS_HPS_Speed" min="1" max="20">
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_PB;?>" id="Rich_Web_VS_HPS_PB" name="Rich_Web_VS_HPS_PB" min="0" max="20">
				...
				<tr>
					...
					<td>
						<input type="text" class="Rich_Web_VSlider_Select_Menu" name="Rich_Web_VS_HPS_NP_NText" id="Rich_Web_VS_HPS_NP_NText" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_NP_NText;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VSlider_Select_Menu" name="Rich_Web_VS_HPS_NP_PText" id="Rich_Web_VS_HPS_NP_PText" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_NP_PText;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_HPS_NP_C" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_NP_C;?>"/>
					</td>
				</tr>
				<tr>
					<td>Background Color <span class="Rich_Web_VSlider_Pro"> (Pro) </span></td>
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_HPS_NP_BgC" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_NP_BgC;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_NP_FS;?>" id="Rich_Web_VS_HPS_NP_FS" name="Rich_Web_VS_HPS_NP_FS" min="8" max="48">
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_NP_BW;?>" id="Rich_Web_VS_HPS_NP_BW" name="Rich_Web_VS_HPS_NP_BW" min="0" max="5">
				...
				<tr>
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_HPS_NP_BC" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_NP_BC;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_NP_BR;?>" id="Rich_Web_VS_HPS_NP_BR" name="Rich_Web_VS_HPS_NP_BR" min="0" max="15">
							<span class="range-slider__value" id="Rich_Web_VS_HPS_NP_BR_1">0</span>
						</div>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_HPS_NP_HC" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_NP_HC;?>"/>
					</td>
				</tr>
				<tr>
					<td>Hover Background Color <span class="Rich_Web_VSlider_Pro"> (Pro) </span></td>
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_HPS_NP_HBgC" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_NP_HBgC;?>"/>
					</td>
					<td colspan="3"></td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_HPS_Cols_BgC" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_Cols_BgC;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_HPS_Cols_BoxShC" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_Cols_BoxShC;?>"/>
					</td>
					<td>
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_HPS_Cols_StShC" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_Cols_StShC;?>"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_HPS_Cols_HShC" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_Cols_HShC;?>"/>
					</td>
					<td colspan="2"></td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_HPS_TC" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_TC;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_TFS;?>" id="Rich_Web_VS_HPS_TFS" name="Rich_Web_VS_HPS_TFS" min="8" max="48">
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VSlider_Select_Menu" name="Rich_Web_VS_HPS_LText" id="Rich_Web_VS_HPS_LText" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_LText;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_HPS_LC" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_LC;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_LFS;?>" id="Rich_Web_VS_HPS_LFS" name="Rich_Web_VS_HPS_LFS" min="8" max="48">
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_HPS_LHC" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_LHC;?>"/>
					</td>
					<td colspan="3"></td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VSlider_Select_Menu" name="Rich_Web_VS_HPS_PText" id="Rich_Web_VS_HPS_PText" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_PText;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_HPS_PBgC" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_PBgC;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_HPS_PC" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_PC;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_PFS;?>" id="Rich_Web_VS_HPS_PFS" name="Rich_Web_VS_HPS_PFS" min="8" max="48">
				...
				<tr>
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_HPS_PHC" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_PHC;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_HPS_PHBgC" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_PHBgC;?>"/>
					</td>
					<td></td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_HPS_Pop_OvC" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_Pop_OvC;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_Pop_BW;?>" id="Rich_Web_VS_HPS_Pop_BW" name="Rich_Web_VS_HPS_Pop_BW" min="0" max="15">
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_HPS_Pop_BC" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_Pop_BC;?>"/>
					</td>
				</tr>
				<tr>
					<td>Box Shadow</td>
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_Pop_BoxSh;?>" id="Rich_Web_VS_HPS_Pop_BoxSh" name="Rich_Web_VS_HPS_Pop_BoxSh" min="0" max="50">
							<span class="range-slider__value" id="Rich_Web_VS_HPS_Pop_BoxSh_1">0</span>
						</div>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_HPS_Pop_BoxShC" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_Pop_BoxShC;?>"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_Pop_CIS;?>" id="Rich_Web_VS_HPS_Pop_CIS" name="Rich_Web_VS_HPS_Pop_CIS" min="8" max="48">
							<span class="range-slider__value" id="Rich_Web_VS_HPS_Pop_CIS_1">0</span>
						</div>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VS_HPS_Pop_CIC" value="<?= $Rich_Web_VS7[0]->Rich_Web_VS_HPS_Pop_CIC;?>"/>
					</td>
					<td></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="Rich_Web_HSL_L_BgC" id="Rich_Web_HSL_L_BgC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS7_Loader[0]->Rich_Web_HSL_L_BgC;?>">
					</td>
				</tr>
				<tr>
					<td>Text Color</td>
				...
				<tr>
					<td>
						<input type="text" name="Rich_Web_HSL_LT_C" id="Rich_Web_HSL_LT_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS7_Loader[0]->Rich_Web_HSL_LT_C;?>">
					</td>
					<td>
						<input type="text" name="Rich_Web_HSL_L_C" id="Rich_Web_HSL_L_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS7_Loader[0]->Rich_Web_HSL_L_C;?>">
					</td>
					<td>
					...
					<td>
						<input type="text" name="Rich_Web_HSL_LT" id="Rich_Web_HSL_LT" value="<?= $Rich_Web_VS7_Loader[0]->Rich_Web_HSL_LT;?>">
					</td>
				</tr>
				<tr>
					<td>Loader Type</td>
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS7_Loader[0]->Rich_Web_HSL_LT_FS;?>" id="Rich_Web_HSL_LT_FS" name="Rich_Web_HSL_LT_FS" min="8" max="25">
				...
				<tr class="Loder_1_Option">
					<td>
						<input type="text" name="Rich_Web_HSL_L_T1_C" id="Rich_Web_HSL_L_T1_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS7_Loader[0]->Rich_Web_HSL_L_T1_C;?>">
					</td>
					<td>
						<input type="text" name="Rich_Web_HSL_L_T2_C" id="Rich_Web_HSL_L_T2_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS7_Loader[0]->Rich_Web_HSL_L_T2_C;?>">
					</td>
					<td>
						<input type="text" name="Rich_Web_HSL_L_T3_C" id="Rich_Web_HSL_L_T3_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS7_Loader[0]->Rich_Web_HSL_L_T3_C;?>">
					</td>
					<td></td>
				</tr>
				<tr class="rw_text_color rw_text_color1">
				...
				<tr class="rw_text_color rw_text_color1">
					<td>
						<input type="text" name="Rich_Web_HSL_LT_T2_BC" id="Rich_Web_HSL_LT_T2_BC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS7_Loader[0]->Rich_Web_HSL_LT_T2_BC;?>">
					</td>
					<td colspan="3"></td>
				</tr>
				<tr class="rw_text_color rw_text_color2">
				...
				<tr class="rw_text_color rw_text_color2">
					<td>
						<input type="text" name="Rich_Web_HSL_LT_T2_AnC" id="Rich_Web_HSL_LT_T2_AnC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS7_Loader[0]->Rich_Web_HSL_LT_T2_AnC;?>">
					</td>
					<td colspan="3"></td>
				</tr>
				<tr class="rw_text_color rw_text_color3">
				...
				<tr class="rw_text_color rw_text_color3">
					<td>
						<input type="text" name="Rich_Web_HSL_LT_T3_BgC" id="Rich_Web_HSL_LT_T3_BgC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS7_Loader[0]->Rich_Web_HSL_LT_T3_BgC;?>">
					</td>
					<td colspan="3"></td>
				</tr>
			</table>
			<table class='Rich_Web_VSlider_Save_Table_2 RWeb_VSlider_Save_Table_2' id="Rich_Web_VSlider_Save_Table_2_8">
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS8[0]->Rich_Web_RVVS_Sh;?>" id="Rich_Web_RVVS_Sh" name="Rich_Web_RVVS_Sh" min="0" max="50">
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_RVVS_ShC" value="<?= $Rich_Web_VS8[0]->Rich_Web_RVVS_ShC;?>"/>
					</td>
					<td>
						<!-- <label class="switch switch-light">
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS8[0]->Rich_Web_RVVS_NI_BW;?>" id="Rich_Web_RVVS_NI_BW" name="Rich_Web_RVVS_NI_BW" min="0" max="5">
							<span class="range-slider__value" id="Rich_Web_RVVS_NI_BW_Span">0</span>
						</div>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_RVVS_NI_BC" value="<?= $Rich_Web_VS8[0]->Rich_Web_RVVS_NI_BC;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_RVVS_NI_BgC" value="<?= $Rich_Web_VS8[0]->Rich_Web_RVVS_NI_BgC;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_RVVS_NI_HBgC" value="<?= $Rich_Web_VS8[0]->Rich_Web_RVVS_NI_HBgC;?>"/>
					</td>
				</tr>
				<tr>
					<td>Hover Border Color <span class="Rich_Web_VSlider_Pro"> (Pro) </span></td>
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_RVVS_NI_HBC" value="<?= $Rich_Web_VS8[0]->Rich_Web_RVVS_NI_HBC;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_RVVS_NI_CBgC" value="<?= $Rich_Web_VS8[0]->Rich_Web_RVVS_NI_CBgC;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_RVVS_NI_CBC" value="<?= $Rich_Web_VS8[0]->Rich_Web_RVVS_NI_CBC;?>"/>
					</td>
					<td></td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS8[0]->Rich_Web_RVVS_NT_FS;?>" id="Rich_Web_RVVS_NT_FS" name="Rich_Web_RVVS_NT_FS" min="8" max="36">
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_RVVS_NT_C" value="<?= $Rich_Web_VS8[0]->Rich_Web_RVVS_NT_C;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_RVVS_NT_HC" value="<?= $Rich_Web_VS8[0]->Rich_Web_RVVS_NT_HC;?>"/>
					</td>
				</tr>
				<tr>
					<td>Current Color <span class="Rich_Web_VSlider_Pro"> (Pro) </span></td>
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_RVVS_NT_CC" value="<?= $Rich_Web_VS8[0]->Rich_Web_RVVS_NT_CC;?>"/>
					</td>
					<td colspan="3"></td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS8[0]->Rich_Web_RVVS_NImg_BW;?>" id="Rich_Web_RVVS_NImg_BW" name="Rich_Web_RVVS_NImg_BW" min="0" max="5">
							<span class="range-slider__value" id="Rich_Web_RVVS_NImg_BW_Span">0</span>
						</div>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_RVVS_NScroll_HBgC" value="<?= $Rich_Web_VS8[0]->Rich_Web_RVVS_NScroll_HBgC;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS8[0]->Rich_Web_RVVS_NImg_BSh;?>" id="Rich_Web_RVVS_NImg_BSh" name="Rich_Web_RVVS_NImg_BSh" min="0" max="30">
							<span class="range-slider__value" id="Rich_Web_RVVS_NImg_BSh_Span">0</span>
						</div>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_RVVS_NImg_ShC" value="<?= $Rich_Web_VS8[0]->Rich_Web_RVVS_NImg_ShC;?>"/>
					</td>
				</tr>
				<tr>
					<td>Shadow Type</td>
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input style="max-width:200px;" class="range-slider__range" type="range" value="<?= $Rich_Web_VS8[0]->Rich_Web_RVVS_NImg_BR;?>" id="Rich_Web_RVVS_NImg_BR" name="Rich_Web_RVVS_NImg_BR" min="0" max="50">
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_RVVS_NScroll_BgC" value="<?= $Rich_Web_VS8[0]->Rich_Web_RVVS_NScroll_BgC;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_RVVS_NScroll_C" value="<?= $Rich_Web_VS8[0]->Rich_Web_RVVS_NScroll_C;?>"/>
					</td>
					<td colspan="2"></td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS8[0]->Rich_Web_RVVS_IT_FS;?>" id="Rich_Web_RVVS_IT_FS" name="Rich_Web_RVVS_IT_FS" min="8" max="36">
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_RVVS_IT_C" value="<?= $Rich_Web_VS8[0]->Rich_Web_RVVS_IT_C;?>"/>
					</td>
					<td></td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS8[0]->Rich_Web_RVVS_PlIc_FS;?>" id="Rich_Web_RVVS_PlIc_FS" name="Rich_Web_RVVS_PlIc_FS" min="8" max="50">
							<span class="range-slider__value" id="Rich_Web_RVVS_PlIc_FS_Span">0</span>
						</div>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_RVVS_PlIc_C" value="<?= $Rich_Web_VS8[0]->Rich_Web_RVVS_PlIc_C;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_RVVS_PlIc_BgC" value="<?= $Rich_Web_VS8[0]->Rich_Web_RVVS_PlIc_BgC;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_RVVS_PlIc_HBgC" value="<?= $Rich_Web_VS8[0]->Rich_Web_RVVS_PlIc_HBgC;?>"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_RVVS_DelIc_C" value="<?= $Rich_Web_VS8[0]->Rich_Web_RVVS_DelIc_C;?>"/>
					</td>
					<td>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS8[0]->Rich_Web_RVVS_DelIc_FS;?>" id="Rich_Web_RVVS_DelIc_FS" name="Rich_Web_RVVS_DelIc_FS" min="8" max="50">
							<span class="range-slider__value" id="Rich_Web_RVVS_DelIc_FS_Span">0</span>
						</div>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_RVVS_DelIc_BgC" value="<?= $Rich_Web_VS8[0]->Rich_Web_RVVS_DelIc_BgC;?>"/>
					</td>
				</tr>
				<tr>
					<td>Hover Background Color <span class="Rich_Web_VSlider_Pro"> (Pro) </span></td>
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_RVVS_DelIc_HBgC" value="<?= $Rich_Web_VS8[0]->Rich_Web_RVVS_DelIc_HBgC;?>"/>
					</td>
					<td colspan="3"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="Rich_Web_RichSl_L_BgC" id="Rich_Web_RichSl_L_BgC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS8_Loader[0]->Rich_Web_RichSl_L_BgC;?>">
					</td>
				</tr>
				<tr>
					<td>Text Color</td>
				...
				<tr>
					<td>
						<input type="text" name="Rich_Web_RichSl_LT_C" id="Rich_Web_RichSl_LT_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS8_Loader[0]->Rich_Web_RichSl_LT_C;?>">
					</td>
					<td>
						<input type="text" name="Rich_Web_RichSl_L_C" id="Rich_Web_RichSl_L_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS8_Loader[0]->Rich_Web_RichSl_L_C;?>">
					</td>
					<td>
					...
					<td>
						<input type="text" name="Rich_Web_RichSl_LT" id="Rich_Web_RichSl_LT" value="<?= $Rich_Web_VS8_Loader[0]->Rich_Web_RichSl_LT;?>">
					</td>
				</tr>
				<tr>
					<td>Loader Type</td>
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS8_Loader[0]->Rich_Web_RichSl_LT_FS;?>" id="Rich_Web_RichSl_LT_FS" name="Rich_Web_RichSl_LT_FS" min="8" max="25">
				...
				<tr class="Loder_1_Option">
					<td>
						<input type="text" name="Rich_Web_RichSl_L_T1_C" id="Rich_Web_RichSl_L_T1_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS8_Loader[0]->Rich_Web_RichSl_L_T1_C;?>">
					</td>
					<td>
						<input type="text" name="Rich_Web_RichSl_L_T2_C" id="Rich_Web_RichSl_L_T2_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS8_Loader[0]->Rich_Web_RichSl_L_T2_C;?>">
					</td>
					<td>
						<input type="text" name="Rich_Web_RichSl_L_T3_C" id="Rich_Web_RichSl_L_T3_C" class="Rich_Web_VS_Color" value="
						<?= $Rich_Web_VS8_Loader[0]->Rich_Web_RichSl_L_T3_C;?>">
					</td>
					<td></td>
				</tr>
				<tr class="rw_text_color rw_text_color1">
				...
				<tr class="rw_text_color rw_text_color1">
					<td>
						<input type="text" name="Rich_Web_RichSl_LT_T2_BC" id="Rich_Web_RichSl_LT_T2_BC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS8_Loader[0]->Rich_Web_RichSl_LT_T2_BC;?>">
					</td>
					<td colspan="3"></td>
				</tr>
				<tr class="rw_text_color rw_text_color2">
				...
				<tr class="rw_text_color rw_text_color2">
					<td>
						<input type="text" name="Rich_Web_RichSl_LT_T2_AnC" id="Rich_Web_RichSl_LT_T2_AnC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS8_Loader[0]->Rich_Web_RichSl_LT_T2_AnC;?>">
					</td>
					<td colspan="3"></td>
				</tr>
				<tr class="rw_text_color rw_text_color3">
				...
				<tr class="rw_text_color rw_text_color3">
					<td>
						<input type="text" name="Rich_Web_RichSl_LT_T3_BgC" id="Rich_Web_RichSl_LT_T3_BgC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS8_Loader[0]->Rich_Web_RichSl_LT_T3_BgC;?>">
					</td>
					<td colspan="3"></td>
				</tr>
			</table>
			<table class='Rich_Web_VSlider_Save_Table_2 RWeb_VSlider_Save_Table_2' id="Rich_Web_VSlider_Save_Table_2_9">
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS9[0]->Rich_Web_MS_SShChT;?>" id="Rich_Web_MS_SShChT" name="Rich_Web_MS_SShChT" min="1000" max="15000">
							<span class="range-slider__value" id="Rich_Web_MS_SShChT_Span">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS9[0]->Rich_Web_MS_BSh;?>" id="Rich_Web_MS_BSh" name="Rich_Web_MS_BSh" min="0" max="50">
							<span class="range-slider__value" id="Rich_Web_MS_BSh_Span">0</span>
						</div>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_MS_ShC" value="<?= $Rich_Web_VS9[0]->Rich_Web_MS_ShC;?>"/>
					</td>
				</tr>
				<tr>
					<td>Shadow Type</td>
				...
				<tr>
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_MS_BgC" value="<?= $Rich_Web_VS9[0]->Rich_Web_MS_BgC;?>"/>
					</td>
					<td>
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS9[0]->Rich_Web_MS_W;?>" id="Rich_Web_MS_W" name="Rich_Web_MS_W" min="320" max="1500">
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS9[0]->Rich_Web_MS_N_BW;?>" id="Rich_Web_MS_N_BW" name="Rich_Web_MS_N_BW" min="0" max="4">
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_MS_N_BC" value="<?= $Rich_Web_VS9[0]->Rich_Web_MS_N_BC;?>"/>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS9[0]->Rich_Web_MS_NI_FS;?>" id="Rich_Web_MS_NI_FS" name="Rich_Web_MS_NI_FS" min="8" max="24">
				...
				<tr>
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_MS_NI_C" value="<?= $Rich_Web_VS9[0]->Rich_Web_MS_NI_C;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_MS_NI_HC" value="<?= $Rich_Web_VS9[0]->Rich_Web_MS_NI_HC;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_MS_NI_CC" value="<?= $Rich_Web_VS9[0]->Rich_Web_MS_NI_CC;?>"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_MS_NIC_C" value="<?= $Rich_Web_VS9[0]->Rich_Web_MS_NIC_C;?>"/>
					</td>
					<td colspan="3"></td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS9[0]->Rich_Web_MS_Img_BW;?>" id="Rich_Web_MS_Img_BW" name="Rich_Web_MS_Img_BW" min="0" max="15">
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_MS_Img_BC" value="<?= $Rich_Web_VS9[0]->Rich_Web_MS_Img_BC;?>"/>
					</td>
					<td>
						<div class="range-slider">
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_MS_Img_ShC" value="<?= $Rich_Web_VS9[0]->Rich_Web_MS_Img_ShC;?>"/>
					</td>
					<td>
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS9[0]->Rich_Web_MS_T_FS;?>" id="Rich_Web_MS_T_FS" name="Rich_Web_MS_T_FS" min="8" max="38">
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_MS_T_C" value="<?= $Rich_Web_VS9[0]->Rich_Web_MS_T_C;?>"/>
					</td>
					<td>
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS9[0]->Rich_Web_MS_T_TSh;?>" id="Rich_Web_MS_T_TSh" name="Rich_Web_MS_T_TSh" min="0" max="5">
							<span class="range-slider__value" id="Rich_Web_MS_T_TSh_Span">0</span>
						</div>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_MS_T_TShC" value="<?= $Rich_Web_VS9[0]->Rich_Web_MS_T_TShC;?>"/>
					</td>
					<td colspan="2"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS9[0]->Rich_Web_MS_Ic_S;?>" id="Rich_Web_MS_Ic_S" name="Rich_Web_MS_Ic_S" min="10" max="50">
							<span class="range-slider__value" id="Rich_Web_MS_Ic_S_Span">0</span>
						</div>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_MS_Ic_C" value="<?= $Rich_Web_VS9[0]->Rich_Web_MS_Ic_C;?>"/>
					</td>
					<td></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS9[0]->Rich_Web_MS_PlIc_S;?>" id="Rich_Web_MS_PlIc_S" name="Rich_Web_MS_PlIc_S" min="10" max="50">
							<span class="range-slider__value" id="Rich_Web_MS_PlIc_S_Span">0</span>
						</div>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_MS_PlIc_BgC" value="<?= $Rich_Web_VS9[0]->Rich_Web_MS_PlIc_BgC;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_MS_PlIc_C" value="<?= $Rich_Web_VS9[0]->Rich_Web_MS_PlIc_C;?>"/>
					</td>
				</tr>
				<tr>
					<td>Hover Background Color <span class="Rich_Web_VSlider_Pro"> (Pro) </span></td>
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_MS_PlIc_HBgC" value="<?= $Rich_Web_VS9[0]->Rich_Web_MS_PlIc_HBgC;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_MS_PlIc_HC" value="<?= $Rich_Web_VS9[0]->Rich_Web_MS_PlIc_HC;?>"/>
					</td>
					<td colspan="2"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="Rich_Web_TSL_L_BgC" id="Rich_Web_TSL_L_BgC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS9_Loader[0]->Rich_Web_TSL_L_BgC;?>">
					</td>
				</tr>
				<tr>
					<td>Text Color</td>
				...
				<tr>
					<td>
						<input type="text" name="Rich_Web_TSL_LT_C" id="Rich_Web_TSL_LT_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS9_Loader[0]->Rich_Web_TSL_LT_C;?>">
					</td>
					<td>
						<input type="text" name="Rich_Web_TSL_L_C" id="Rich_Web_TSL_L_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS9_Loader[0]->Rich_Web_TSL_L_C;?>">
					</td>
					<td>
					...
					<td>
						<input type="text" name="Rich_Web_TSL_LT" id="Rich_Web_TSL_LT" value="<?= $Rich_Web_VS9_Loader[0]->Rich_Web_TSL_LT;?>">
					</td>
				</tr>
				<tr>
					<td>Loader Type</td>
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS9_Loader[0]->Rich_Web_TSL_LT_FS;?>" id="Rich_Web_TSL_LT_FS" name="Rich_Web_TSL_LT_FS" min="8" max="25">
				...
				<tr class="Loder_1_Option">
					<td>
						<input type="text" name="Rich_Web_TSL_L_T1_C" id="Rich_Web_TSL_L_T1_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS9_Loader[0]->Rich_Web_TSL_L_T1_C;?>">
					</td>
					<td>
						<input type="text" name="Rich_Web_TSL_L_T2_C" id="Rich_Web_TSL_L_T2_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS9_Loader[0]->Rich_Web_TSL_L_T2_C;?>">
					</td>
					<td>
						<input type="text" name="Rich_Web_TSL_L_T3_C" id="Rich_Web_TSL_L_T3_C" class="Rich_Web_VS_Color" value="Rich_Web_VS_Color" value="<?= $Rich_Web_VS9_Loader[0]->Rich_Web_TSL_L_T3_C;?>">
					</td>
					<td></td>
				</tr>
				<tr class="rw_text_color rw_text_color1">
				...
				<tr class="rw_text_color rw_text_color1">
					<td>
						<input type="text" name="Rich_Web_TSL_LT_T2_BC" id="Rich_Web_TSL_LT_T2_BC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS9_Loader[0]->Rich_Web_TSL_LT_T2_BC;?>">
					</td>
					<td colspan="3"></td>
				</tr>
				<tr class="rw_text_color rw_text_color2">
				...
				<tr class="rw_text_color rw_text_color2">
					<td>
						<input type="text" name="Rich_Web_TSL_LT_T2_AnC" id="Rich_Web_TSL_LT_T2_AnC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS9_Loader[0]->Rich_Web_TSL_LT_T2_AnC;?>">
					</td>
					<td colspan="3"></td>
				</tr>
				<tr class="rw_text_color rw_text_color3">
				...
				<tr class="rw_text_color rw_text_color3">
					<td>
						<input type="text" name="Rich_Web_TSL_LT_T3_BgC" id="Rich_Web_TSL_LT_T3_BgC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS9_Loader[0]->Rich_Web_TSL_LT_T3_BgC;?>">
					</td>
					<td colspan="3"></td>
				</tr>
			</table>
			<table class='Rich_Web_VSlider_Save_Table_2 RWeb_VSlider_Save_Table_2' id="Rich_Web_VSlider_Save_Table_2_10">
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS10[0]->Rich_Web_GO_NS1_Width;?>" id="Rich_Web_GO_NS1_Width" name="Rich_Web_GO_NS1_Width" min="8" max="1500">
							<span class="range-slider__value" id="Rich_Web_GO_NS1_Width_Span">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS10[0]->Rich_Web_GO_NS1_Height;?>" id="Rich_Web_GO_NS1_Height" name="Rich_Web_GO_NS1_Height" min="8" max="1000">
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS10[0]->Rich_Web_GO_NS1_PTime;?>" id="Rich_Web_GO_NS1_PTime" name="Rich_Web_GO_NS1_PTime" min="1" max="50">
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS10[0]->Rich_Web_GO_NS1_BW;?>" id="Rich_Web_GO_NS1_BW" name="Rich_Web_GO_NS1_BW" min="1" max="10">
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_GO_NS1_BC" value="<?= $Rich_Web_VS10[0]->Rich_Web_GO_NS1_BC;?>"/>
					</td>
					<td>
				...
				<tr>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS10[0]->Rich_Web_GO_NS1_BSh;?>" id="Rich_Web_GO_NS1_BSh" name="Rich_Web_GO_NS1_BSh" min="8" max="50">
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_GO_NS1_BSh_Col" value="<?= $Rich_Web_VS10[0]->Rich_Web_GO_NS1_BSh_Col;?>"/>
					</td>
					<td>
						<label class="switch switch-light">
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS10[0]->Rich_Web_TO_NS1_FSize;?>" id="Rich_Web_TO_NS1_FSize" name="Rich_Web_TO_NS1_FSize" min="8" max="50">
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_TO_NS1_Col" value="<?= $Rich_Web_VS10[0]->Rich_Web_TO_NS1_Col;?>"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS10[0]->Rich_Web_TO_NS1_Num_FSize;?>" id="Rich_Web_TO_NS1_Num_FSize" name="Rich_Web_TO_NS1_Num_FSize" min="8" max="50">
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_TO_NS1_Num_Col" value="<?= $Rich_Web_VS10[0]->Rich_Web_TO_NS1_Num_Col;?>"/>
					</td>
				</tr>
				<tr>
					<td colspan="4">Navigation Options</td>
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS10[0]->Rich_Web_PO_NS1_Width;?>" id="Rich_Web_PO_NS1_Width" name="Rich_Web_PO_NS1_Width" min="5" max="20">
							<span class="range-slider__value" id="Rich_Web_PO_NS1_Width_Span">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS10[0]->Rich_Web_PO_NS1_Height;?>" id="Rich_Web_PO_NS1_Height" name="Rich_Web_PO_NS1_Height" min="5" max="20">
							<span class="range-slider__value" id="Rich_Web_PO_NS1_Height_Span">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS10[0]->Rich_Web_PO_NS1_PB;?>" id="Rich_Web_PO_NS1_PB" name="Rich_Web_PO_NS1_PB" min="1" max="10">
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_PO_NS1_Col" value="<?= $Rich_Web_VS10[0]->Rich_Web_PO_NS1_Col;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_PO_NS1_Cur_Col" value="<?= $Rich_Web_VS10[0]->Rich_Web_PO_NS1_Cur_Col;?>"/>
					</td>
					<td colspan="2"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<div class="Rich_Web_IO_NS1_Icon_Col_Block">
							<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_PO_NS1_Hov_Col" value="<?= $Rich_Web_VS10[0]->Rich_Web_PO_NS1_Hov_Col;?>"/>
						</div>
					</td>
					<td>
						<div class="Rich_Web_IO_NS1_Icon_Col_Block">
							<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_IO_NS1_BgCol" value="<?= $Rich_Web_VS10[0]->Rich_Web_IO_NS1_BgCol;?>"/>
						</div>
					</td>
				</tr>
				...
				<tr class="Rich_Web_IO_NS1_Icon_Col_Block_DIV">
					<td>
						<div class="Rich_Web_IO_NS1_Icon_Col_Block">
							<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_IO_NS1_HovBgCol" value="<?= $Rich_Web_VS10[0]->Rich_Web_IO_NS1_HovBgCol;?>"/>
						</div>
					</td>
					<td>
						<div class="Rich_Web_IO_NS1_Icon_Col_Block">
							<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_IO_NS1_Col" value="<?= $Rich_Web_VS10[0]->Rich_Web_IO_NS1_Col;?>"/>
						</div>
					</td>
					<td>
					...
					<td>
						<div class="range-slider Rich_Web_IO_NS1_FSize_Block">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS10[0]->Rich_Web_IO_NS1_FSize;?>" id="Rich_Web_IO_NS1_FSize" name="Rich_Web_IO_NS1_FSize" min="8" max="50">
				...
				<tr class="Rich_Web_IO_NS1_IMG_Type">
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS10[0]->Rich_Web_IO_NS1_Width;?>" id="Rich_Web_IO_NS1_Width" name="Rich_Web_IO_NS1_Width" min="8" max="50">
							<span class="range-slider__value" id="Rich_Web_IO_NS1_Width_Span">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS10[0]->Rich_Web_IO_NS1_Height;?>" id="Rich_Web_IO_NS1_Height" name="Rich_Web_IO_NS1_Height" min="8" max="50">
				...
				<tr>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_PIO_NS1_BgCol" value="<?= $Rich_Web_VS10[0]->Rich_Web_PIO_NS1_BgCol;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_PIO_NS1_Col" value="<?= $Rich_Web_VS10[0]->Rich_Web_PIO_NS1_Col;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_PIO_NS1_HovBgCol" value="<?= $Rich_Web_VS10[0]->Rich_Web_PIO_NS1_HovBgCol;?>"/>
					</td>
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_PIO_NS1_HovCol" value="<?= $Rich_Web_VS10[0]->Rich_Web_PIO_NS1_HovCol;?>"/>
					</td>
				</tr>
				<tr>
					<td colspan="4">Loading Options</td>
				...
				<tr>
					...
					<td>
						<input type="text" name="Rich_Web_ASSl_L_BgC" id="Rich_Web_ASSl_L_BgC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS10_Loader[0]->Rich_Web_ASSl_L_BgC;?>">
					</td>
				</tr>
				<tr>
					<td>Text Color</td>
				...
				<tr>
					<td>
						<input type="text" name="Rich_Web_ASSl_LT_C" id="Rich_Web_ASSl_LT_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS10_Loader[0]->Rich_Web_ASSl_LT_C;?>">
					</td>
					<td>
						<input type="text" name="Rich_Web_ASSl_L_C" id="Rich_Web_ASSl_L_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS10_Loader[0]->Rich_Web_ASSl_L_C;?>">
					</td>
					<td>
					...
					<td>
						<input type="text" name="Rich_Web_ASSl_LT" id="Rich_Web_ASSl_LT" value="<?= $Rich_Web_VS10_Loader[0]->Rich_Web_ASSl_LT;?>">
					</td>
				</tr>
				<tr>
					<td>Loader Type</td>
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="<?= $Rich_Web_VS10_Loader[0]->Rich_Web_ASSl_LT_FS;?>" id="Rich_Web_ASSl_LT_FS" name="Rich_Web_ASSl_LT_FS" min="8" max="25">
				...
				<tr class="Loder_1_Option">
					<td>
						<input type="text" name="Rich_Web_ASSl_L_T1_C" id="Rich_Web_ASSl_L_T1_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS10_Loader[0]->Rich_Web_ASSl_L_T1_C;?>">
					</td>
					<td>
						<input type="text" name="Rich_Web_ASSl_L_T2_C" id="Rich_Web_ASSl_L_T2_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS10_Loader[0]->Rich_Web_ASSl_L_T2_C;?>">
					</td>
					<td>
						<input type="text" name="Rich_Web_ASSl_L_T3_C" id="Rich_Web_ASSl_L_T3_C" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS10_Loader[0]->Rich_Web_ASSl_L_T3_C;?>">
					</td>
					<td></td>
				</tr>
				<tr class="rw_text_color rw_text_color1">
				...
				<tr class="rw_text_color rw_text_color1">
					<td>
						<input type="text" name="Rich_Web_ASSl_LT_T2_BC" id="Rich_Web_ASSl_LT_T2_BC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS10_Loader[0]->Rich_Web_ASSl_LT_T2_BC;?>">
					</td>
					<td colspan="3"></td>
				</tr>
				<tr class="rw_text_color rw_text_color2">
				...
				<tr class="rw_text_color rw_text_color2">
					<td>
						<input type="text" name="Rich_Web_ASSl_LT_T2_AnC" id="Rich_Web_ASSl_LT_T2_AnC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS10_Loader[0]->Rich_Web_ASSl_LT_T2_AnC;?>">
					</td>
					<td colspan="3"></td>
				</tr>
				<tr class="rw_text_color rw_text_color3">
				...
				<tr class="rw_text_color rw_text_color3">
					<td>
						<input type="text" name="Rich_Web_ASSl_LT_T3_BgC" id="Rich_Web_ASSl_LT_T3_BgC" class="Rich_Web_VS_Color" value="<?= $Rich_Web_VS10_Loader[0]->Rich_Web_ASSl_LT_T3_BgC;?>">
					</td>
					<td colspan="3"></td>
				</tr>
			</table>
