				<style type="text/css">
					...
					#RW_Load_Timeline_Navigation<?= $Rich_Web_VSlider_ID; ?>
					{
						position:relative;
						margin:20px auto !important;
						background-color:<?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_L_BgC; ?> !important;
						z-index:2;
						width:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_MS_W; ?>px;
						height:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_MS_W*56.25/100; ?>px;
					...
					<?php if($Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_L_S == "small") { ?>
						...
						{
							border-top: 3px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_L_T1_C; ?> !important;
							border-bottom: 3px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_L_T1_C; ?> !important;
						}
						.loader_Navigation2<?= $Rich_Web_VSlider_ID; ?>
						{
							border-top: 3px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_L_T2_C; ?> !important;
							border-bottom: 3px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_L_T2_C; ?> !important;
						}
						.loader_Navigation3<?= $Rich_Web_VSlider_ID; ?>
						{
							border-top:12px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_L_T3_C; ?> !important;
							border-bottom:12px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_L_T3_C; ?> !important;
							border-right:12px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_L_T3_C; ?> !important;
							width:50% !important;
							height:50% !important;
						}
					<?php } elseif($Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_L_S == "middle") { ?>
						...
						.loader_Navigation1<?= $Rich_Web_VSlider_ID; ?>
						{
							border-top: 4px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_L_T1_C; ?> !important;
							border-bottom: 4px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_L_T1_C; ?> !important;
						}
						.loader_Navigation2<?= $Rich_Web_VSlider_ID; ?>
						{
							border-top: 4px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_L_T2_C; ?> !important;
							border-bottom: 4px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_L_T2_C; ?> !important;
						}
						.loader_Navigation3<?= $Rich_Web_VSlider_ID; ?>
						{
							border-top:17px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_L_T3_C; ?> !important;
							border-bottom:17px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_L_T3_C; ?> !important;
							border-right:17px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_L_T3_C; ?> !important;
							width:55% !important;
							height:55% !important;
						}
					<?php } else { ?>
						...
						.loader_Navigation1<?= $Rich_Web_VSlider_ID; ?>
						{
							border-top: 5px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_L_T1_C; ?> !important;
							border-bottom: 5px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_L_T1_C; ?> !important;
						}
						.loader_Navigation2<?= $Rich_Web_VSlider_ID; ?>
						{
							border-top: 5px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_L_T2_C; ?> !important;
							border-bottom: 5px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_L_T2_C; ?> !important;
						}
						.loader_Navigation3<?= $Rich_Web_VSlider_ID; ?>
						{
							border-top:25px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_L_T3_C; ?> !important;
							border-bottom:25px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_L_T3_C; ?> !important;
							border-right:25px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_L_T3_C; ?> !important;
							width:60% !important;
							height:60% !important;
						}
					<?php } ?>
					...
					.RW_Loader_Text_Navigation<?= $Rich_Web_VSlider_ID; ?>
					{
						...
						text-align:center;
						margin-top:10px;
						font-size: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_LT_FS; ?>px !important;
						font-family:<?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_LT_FF; ?> !important;
						color: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_LT_C; ?> !important;
					}
					...
					.loader<?= $Rich_Web_VSlider_ID; ?> div
					{
						...
						height: 8px;
						border-radius: 50%;
						border: 1px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_L_C; ?>;
						position: absolute;
						top: 2px;
						left: 0;
						right: 0;
					...
					.windows8<?= $Rich_Web_VSlider_ID; ?> .wBall .wInnerBall
					{
						...
						width: 10px;
						height: 10px;
						background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_L_C; ?>;
						left:0px;
						top:0px;
						border-radius: 10px;
					}
					...
					.cssload-thecube<?= $Rich_Web_VSlider_ID; ?> .cssload-cube:before
					{
						...
						width: 100%;
						height: 100%;
						background-color: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_L_C; ?>;
					...
					.cssload-loader<?= $Rich_Web_VSlider_ID; ?>::before, .cssload-loader<?= $Rich_Web_VSlider_ID; ?>::after
					{
						...
						width: 15px;
						height: 15px;
						background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_LT_T2_BC; ?> !important;
						position: absolute;
					...
					{
						0% { color:<?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_LT_T2_AnC; ?>; }
						100% { color:<?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_LT_C; ?> !important; }
					}
					...
					{
						position: relative;
						width: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_LT_FS*2; ?>px;
						height: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_LT_FS*2; ?>px;
					...
					<?php foreach($text_array as $key=>$v) { ?>
						...
						{
							background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_LT_T3_BgC; ?> !important;
							margin-right: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_LT_FS; ?>px !important;
					...
					@keyframes cssload-movement<?= $Rich_Web_VSlider_ID; ?>
					{
						...
						to {
							...
							box-shadow: 0 24px 39px <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_LT_T3_BgC; ?>;
							background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_LT_T3_BgC; ?> !important;
						}
					}
					@-o-keyframes cssload-movement<?= $Rich_Web_VSlider_ID; ?>
					{
						...
						to {
							...
							-o-box-shadow: 0 24px 39px <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_LT_T3_BgC; ?>;
							background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_LT_T3_BgC; ?> !important;
						}
					}
					@-ms-keyframes cssload-movement<?= $Rich_Web_VSlider_ID; ?>
					{
						...
						to {
							...
							-ms-box-shadow: 0 24px 39px <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_LT_T3_BgC; ?>;
							background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_LT_T3_BgC; ?> !important;
						}
					}
					@-webkit-keyframes cssload-movement<?= $Rich_Web_VSlider_ID; ?>
					{
						...
						to {
							...
							-webkit-box-shadow: 0 24px 39px <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_LT_T3_BgC; ?>;
							background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_LT_T3_BgC; ?> !important;
						}
					}
					@-moz-keyframes cssload-movement<?= $Rich_Web_VSlider_ID; ?>
					{
						...
						to {
							...
							-moz-box-shadow: 0 24px 39px <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_LT_T3_BgC; ?>;
							background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_TSL_LT_T3_BgC; ?> !important;
						}
					}
				</style>