...
#RW_Load_VCCP_Navigation<?= $Rich_Web_VSlider_ID; ?>
{
	position:relative;
	margin:20px auto !important;
	background-color:<?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_L_BgC; ?> !important;
	z-index:2;
	width:100%;
	padding-bottom:30%;
...
<?php if($Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_L_S == "small") { ?>
	...
	{
		border-top: 3px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_L_T1_C; ?> !important;
		border-bottom: 3px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_L_T1_C; ?> !important;
	}
	.loader_Navigation2<?= $Rich_Web_VSlider_ID; ?>
	{
		border-top: 3px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_L_T2_C; ?> !important;
		border-bottom: 3px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_L_T2_C; ?> !important;
	}
	.loader_Navigation3<?= $Rich_Web_VSlider_ID; ?>
	{
		border-top:12px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_L_T3_C; ?> !important;
		border-bottom:12px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_L_T3_C; ?> !important;
		border-right:12px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_L_T3_C; ?> !important;
		width:50% !important;
		height:50% !important;
	}
<?php } elseif($Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_L_S == "middle") { ?>
	...
	.loader_Navigation1<?= $Rich_Web_VSlider_ID; ?>
	{
		border-top: 4px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_L_T1_C; ?> !important;
		border-bottom: 4px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_L_T1_C; ?> !important;
	}
	.loader_Navigation2<?= $Rich_Web_VSlider_ID; ?>
	{
		border-top: 4px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_L_T2_C; ?> !important;
		border-bottom: 4px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_L_T2_C; ?> !important;
	}
	.loader_Navigation3<?= $Rich_Web_VSlider_ID; ?>
	{
		border-top:17px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_L_T3_C; ?> !important;
		border-bottom:17px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_L_T3_C; ?> !important;
		border-right:17px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_L_T3_C; ?> !important;
		width:55% !important;
		height:55% !important;
	}
<?php } else { ?>
	...
	.loader_Navigation1<?= $Rich_Web_VSlider_ID; ?>
	{
		border-top: 5px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_L_T1_C; ?> !important;
		border-bottom: 5px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_L_T1_C; ?> !important;
	}
	.loader_Navigation2<?= $Rich_Web_VSlider_ID; ?>
	{
		border-top: 5px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_L_T2_C; ?> !important;
		border-bottom: 5px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_L_T2_C; ?> !important;
	}
	.loader_Navigation3<?= $Rich_Web_VSlider_ID; ?>
	{
		border-top:25px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_L_T3_C; ?> !important;
		border-bottom:25px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_L_T3_C; ?> !important;
		border-right:25px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_L_T3_C; ?> !important;
		width:60% !important;
		height:60% !important;
	}
<?php } ?>
...
.RW_Loader_Text_Navigation<?= $Rich_Web_VSlider_ID; ?>
{
	...
	text-align:center;
	margin-top:10px;
	font-size: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_LT_FS; ?>px !important;
	font-family:<?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_LT_FF; ?> !important;
	color: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_LT_C; ?> !important;
}
...
.loader<?= $Rich_Web_VSlider_ID; ?> div
{
	...
	height: 8px;
	border-radius: 50%;
	border: 1px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_L_C; ?>;
	position: absolute;
	top: 2px;
	left: 0;
	right: 0;
...
.windows8<?= $Rich_Web_VSlider_ID; ?> .wBall .wInnerBall
{
	...
	width: 10px;
	height: 10px;
	background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_L_C; ?>;
	left:0px;
	top:0px;
	border-radius: 10px;
}
...
.cssload-thecube<?= $Rich_Web_VSlider_ID; ?> .cssload-cube:before
{
	...
	width: 100%;
	height: 100%;
	background-color: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_L_C; ?>;
...
.cssload-loader<?= $Rich_Web_VSlider_ID; ?>::before, .cssload-loader<?= $Rich_Web_VSlider_ID; ?>::after
{
	...
	width: 15px;
	height: 15px;
	background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_LT_T2_BC; ?> !important;
	position: absolute;
...
{
	0% { color:<?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_LT_T2_AnC; ?>; }
	100% { color:<?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_LT_C; ?> !important; }
}
...
{
	position: relative;
	width: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_LT_FS*2; ?>px;
	height: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_LT_FS*2; ?>px;
...
<?php foreach($text_array as $key=>$v) { ?>
	...
	{
		background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_LT_T3_BgC; ?> !important;
		margin-right: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_LT_FS; ?>px !important;
...
@keyframes cssload-movement<?= $Rich_Web_VSlider_ID; ?>
{
	...
	to {
		...
		box-shadow: 0 24px 39px <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_LT_T3_BgC; ?>;
		background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_LT_T3_BgC; ?> !important;
	}
}
@-o-keyframes cssload-movement<?= $Rich_Web_VSlider_ID; ?>
{
	...
	to {
		...
		-o-box-shadow: 0 24px 39px <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_LT_T3_BgC; ?>;
		background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_LT_T3_BgC; ?> !important;
	}
}
@-ms-keyframes cssload-movement<?= $Rich_Web_VSlider_ID; ?>
{
	...
	to {
		...
		-ms-box-shadow: 0 24px 39px <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_LT_T3_BgC; ?>;
		background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_LT_T3_BgC; ?> !important;
	}
}
@-webkit-keyframes cssload-movement<?= $Rich_Web_VSlider_ID; ?>
{
	...
	to {
		...
		-webkit-box-shadow: 0 24px 39px <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_LT_T3_BgC; ?>;
		background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_LT_T3_BgC; ?> !important;
	}
}
@-moz-keyframes cssload-movement<?= $Rich_Web_VSlider_ID; ?>
{
	...
	to {
		...
		-moz-box-shadow: 0 24px 39px <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_LT_T3_BgC; ?>;
		background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VCCP_LT_T3_BgC; ?> !important;
	}
}
.carousel<?= $Rich_Web_VSlider_ID; ?>
{
	position:relative;
	min-height: 20px;
	height:auto !important;
	background:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Car_Bg_Color;?> center center no-repeat;
	border:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Car_Border_Width;?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Car_Border_Style;?> <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Car_Border_Color;?>;
	box-shadow:0px 0px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Car_Box_Shadow;?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Car_Shadow_Color;?>;
	-moz-box-shadow:0px 0px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Car_Box_Shadow;?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Car_Shadow_Color;?>;
	-webkit-box-shadow:0px 0px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Car_Box_Shadow;?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Car_Shadow_Color;?>;
}
.wrap<?= $Rich_Web_VSlider_ID; ?>
{
	padding-left: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Car_PBImgs;?>px;
	/*padding-right: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Car_PBImgs;?>px;*/
	width:100% !important;
	height:100%;
...
.carousel<?= $Rich_Web_VSlider_ID; ?> .next<?= $Rich_Web_VSlider_ID; ?>,.carousel<?= $Rich_Web_VSlider_ID; ?> .prev<?= $Rich_Web_VSlider_ID; ?>
{
	display:none;
	width:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Car_Icons_Size;?>px;
	height:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Car_Icons_Size;?>px;
	position:absolute;
	bottom:0px;
	z-index:2;
	cursor:pointer;
...
.carousel<?= $Rich_Web_VSlider_ID; ?> .prev<?= $Rich_Web_VSlider_ID; ?>
{
	background:url(<?= plugin_dir_url(__DIR__).'Images/icons/icon-'. $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Car_Icons_Type .'.png';?>) 0 0 no-repeat;
	background-size:100% 100%;
	top:50%;
	transform:translateY(-50%);
	-webkit-transform:translateY(-50%);
	-ms-transform:translateY(-50%);
	left:<?= -$Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Car_Icons_Size/2;?>px;
}
.carousel<?= $Rich_Web_VSlider_ID; ?> .next<?= $Rich_Web_VSlider_ID; ?>
{
	background:url(<?= plugin_dir_url(__DIR__).'Images/icons/icon-'. $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Car_Icons_Type .'-'. $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Car_Icons_Type .'.png';?>) 0 0 no-repeat;
	background-size:100% 100%;
	right:<?= -$Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Car_Icons_Size/2;?>px;
	top:50%;
	transform:translateY(-50%);
	-webkit-transform:translateY(-50%);
	-ms-transform:translateY(-50%);
}
.carousel<?= $Rich_Web_VSlider_ID; ?> li { display:none; padding:0px !important; background:none !important; margin:0px !important; }
.carousel<?= $Rich_Web_VSlider_ID; ?> li img { width:100%; height:100%; max-width:none !important;}
.paging { position:absolute; z-index:9998; }
.paging > a { display:block; cursor:pointer; width:40px; height:40px; float:left; background:url(<?= plugin_dir_url(__DIR__).'Images/dots.png';?>) 0px -40px no-repeat; }
.paging > a:hover,
.paging > a.current { background:url(<?= plugin_dir_url(__DIR__).'Images/dots.png';?>) 0px 0px no-repeat; }
img { -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; -o-user-select: none; user-select: none; }
.popF1<?= $Rich_Web_VSlider_ID; ?>
{
	position:fixed;
	background:red;
	left:0px;
...
.popVideo1<?= $Rich_Web_VSlider_ID; ?>
{
	...
	-moz-transform:translateY(-50%) translateX(-50%);
	-o-transform:translateY(-50%) translateX(-50%);
	box-shadow:0px 0px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Popup_Box_Shadow;?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Popup_Shadow_Color;?>;
	-moz-box-shadow:0px 0px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Popup_Box_Shadow;?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Popup_Shadow_Color;?>;
	-webkit-box-shadow:0px 0px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Popup_Box_Shadow;?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Popup_Shadow_Color;?>;
	-webkit-transition: all 500ms cubic-bezier(0.950, 0.050, 0.795, 0.035);
	-moz-transition: all 500ms cubic-bezier(0.950, 0.050, 0.795, 0.035);
	-o-transition: all 500ms cubic-bezier(0.950, 0.050, 0.795, 0.035);
	transition: all 500ms cubic-bezier(0.950, 0.050, 0.795, 0.035);
}
.popVideo1<?= $Rich_Web_VSlider_ID; ?>_1
{
	height:500px;
	width:1000px;
	max-width:90%;
...
.popVideo1<?= $Rich_Web_VSlider_ID; ?>_2
{
	height:420px;
	width:560px;
	max-width:90%;
...
.popVideo1<?= $Rich_Web_VSlider_ID; ?>_rel { position:relative; overflow:hidden; width:100%; height:100%; }
.vid { position:relative; width:50%; height:60%; float:left; margin:2%; }
.videoo<?= $Rich_Web_VSlider_ID; ?>
{
	position:absolute;
...
.videoo<?= $Rich_Web_VSlider_ID; ?>_anim
{
	top:0% !important;
...
.titleDescLink<?= $Rich_Web_VSlider_ID; ?> { position:relative; width:40%; height:90%; float:right; margin:2%; overflow:hidden; }
.descr<?= $Rich_Web_VSlider_ID; ?> { position:absolute; margin:0px 10px 0px 10px !important; padding: 0px !important; line-height: 1 !important; }
.descr<?= $Rich_Web_VSlider_ID; ?> p { margin:0px !important; padding: 0px !important; line-height: 1 !important; }
.titleDescLink<?= $Rich_Web_VSlider_ID; ?>_anim
{
	position:absolute;
	width:100%;
	height:100%;
...
.titleDescLink<?= $Rich_Web_VSlider_ID; ?>_anim2
{
	left:0px !important;
	-webkit-transition: all 250ms linear;
	-moz-transition: all 250ms linear;
...
.titleDescLink<?= $Rich_Web_VSlider_ID; ?>3 { width:100% !important; height:28% !important; float:none !important; margin:0px !important; }
.titleDescLink<?= $Rich_Web_VSlider_ID; ?>3 h2 { text-align:center !important; }
.popL<?= $Rich_Web_VSlider_ID; ?>
{
	position: absolute;
	right: 0px;
	font-size: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Link_Font_Size;?>px;
	font-family: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Link_Font_Family;?>;
	color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Link_Color;?> !important;
	background:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Link_Bg_Color;?>;
	bottom: 0px;
	border-radius:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Link_Border_Radius;?>px;
	transform:translateY(120%);
	-webkit-transform:translateY(120%);
	-moz-transform:translateY(120%);
	-ms-transform:translateY(120%);
	border: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Link_Border_Width;?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Link_Border_Style;?> <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Link_Border_Color;?>;
	border-width:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Link_Border_Width;?>px !important;
...
.popL<?= $Rich_Web_VSlider_ID; ?>:hover
{
	background:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Link_Hov_Bg_Color;?>;
	color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Link_Hov_Color;?> !important;
	border: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Link_Border_Width;?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Link_Border_Style;?> <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Link_Hov_Border_Color;?>;
	text-decoration:none;
}
.minTit<?= $Rich_Web_VSlider_ID; ?>
{
	position: absolute;
	left: 0px;
	font-size: 20px;
...
.figurForImg<?= $Rich_Web_VSlider_ID; ?> { width:100%; height:100%; overflow:hidden; margin-left:0%; margin:0px; }
.fImgH1
{
	width:100%;
	margin-left:0%;
...
.titleDescLink<?= $Rich_Web_VSlider_ID; ?>_anim::-webkit-scrollbar { width: 5px; }
.titleDescLink<?= $Rich_Web_VSlider_ID; ?>_anim::-webkit-scrollbar-track
{
	-webkit-box-shadow: inset 0 0 6px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Desc_Bg_Color;?>;
}
.titleDescLink<?= $Rich_Web_VSlider_ID; ?>_anim::-webkit-scrollbar-thumb
{
	background-color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Title_Color;?>;
	outline: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Title_Color;?>;
}
.comment_content ul li:before, .entry-content ul li:before { display:none; }
.tit<?= $Rich_Web_VSlider_ID; ?> { text-transform:none !important; letter-spacing: inherit !important; }

.popDiv<?= $Rich_Web_VSlider_ID; ?>{
	position:fixed;
	top:0;
	left:0;
	width:100%;
...
.popDiv<?= $Rich_Web_VSlider_ID; ?>_center{
...
.forPopp<?= $Rich_Web_VSlider_ID; ?>{
	height:100% !important;
}
.figurForImg<?= $Rich_Web_VSlider_ID; ?>{
	display: flex;
	display: -webkit-flex;
	justify-content: center;
	align-items: center;
}
.figurForImg<?= $Rich_Web_VSlider_ID; ?> i{
	display: block;
	position: absolute;
	color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VC_Car_Bg_Color;?>;
	opacity: 0.5;
	z-index: 2;
}
.figurForImg<?= $Rich_Web_VSlider_ID; ?>:hover i{
	opacity: 1;
}
