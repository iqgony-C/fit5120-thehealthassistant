...
#RW_Load_VSVT_Navigation<?= $Rich_Web_VSlider_ID; ?>
{
	position:relative;
	margin:20px auto !important;
	background-color:<?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_L_BgC; ?> !important;
	z-index:2;
	width:750px;
	height:375px;
...
<?php if($Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_L_S == "small") { ?>
	...
	{
		border-top: 3px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_L_T1_C; ?> !important;
		border-bottom: 3px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_L_T1_C; ?> !important;
	}
	.loader_Navigation2<?= $Rich_Web_VSlider_ID; ?>
	{
		border-top: 3px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_L_T2_C; ?> !important;
		border-bottom: 3px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_L_T2_C; ?> !important;
	}
	.loader_Navigation3<?= $Rich_Web_VSlider_ID; ?>
	{
		border-top:12px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_L_T3_C; ?> !important;
		border-bottom:12px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_L_T3_C; ?> !important;
		border-right:12px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_L_T3_C; ?> !important;
		width:50% !important;
		height:50% !important;
	}
<?php } elseif($Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_L_S == "middle") { ?>
	...
	.loader_Navigation1<?= $Rich_Web_VSlider_ID; ?>
	{
		border-top: 4px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_L_T1_C; ?> !important;
		border-bottom: 4px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_L_T1_C; ?> !important;
	}
	.loader_Navigation2<?= $Rich_Web_VSlider_ID; ?>
	{
		border-top: 4px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_L_T2_C; ?> !important;
		border-bottom: 4px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_L_T2_C; ?> !important;
	}
	.loader_Navigation3<?= $Rich_Web_VSlider_ID; ?>
	{
		border-top:17px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_L_T3_C; ?> !important;
		border-bottom:17px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_L_T3_C; ?> !important;
		border-right:17px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_L_T3_C; ?> !important;
		width:55% !important;
		height:55% !important;
	}
<?php } else { ?>
	...
	.loader_Navigation1<?= $Rich_Web_VSlider_ID; ?>
	{
		border-top: 5px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_L_T1_C; ?> !important;
		border-bottom: 5px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_L_T1_C; ?> !important;
	}
	.loader_Navigation2<?= $Rich_Web_VSlider_ID; ?>
	{
		border-top: 5px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_L_T2_C; ?> !important;
		border-bottom: 5px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_L_T2_C; ?> !important;
	}
	.loader_Navigation3<?= $Rich_Web_VSlider_ID; ?>
	{
		border-top:25px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_L_T3_C; ?> !important;
		border-bottom:25px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_L_T3_C; ?> !important;
		border-right:25px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_L_T3_C; ?> !important;
		width:60% !important;
		height:60% !important;
	}
<?php } ?>
...
.RW_Loader_Text_Navigation<?= $Rich_Web_VSlider_ID; ?>
{
	...
	text-align:center;
	margin-top:10px;
	font-size: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_LT_FS; ?>px !important;
	font-family:<?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_LT_FF; ?> !important;
	color: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_LT_C; ?> !important;
}
...
.loader<?= $Rich_Web_VSlider_ID; ?> div
{
	...
	height: 8px;
	border-radius: 50%;
	border: 1px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_L_C; ?>;
	position: absolute;
	top: 2px;
	left: 0;
	right: 0;
...
.windows8<?= $Rich_Web_VSlider_ID; ?> .wBall .wInnerBall
{
	...
	width: 10px;
	height: 10px;
	background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_L_C; ?>;
	left:0px;
	top:0px;
	border-radius: 10px;
}
...
.cssload-thecube<?= $Rich_Web_VSlider_ID; ?> .cssload-cube:before
{
	...
	width: 100%;
	height: 100%;
	background-color: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_L_C; ?>;
...
.cssload-loader<?= $Rich_Web_VSlider_ID; ?>::before, .cssload-loader<?= $Rich_Web_VSlider_ID; ?>::after
{
	...
	width: 15px;
	height: 15px;
	background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_LT_T2_BC; ?> !important;
	position: absolute;
...
{
	0% { color:<?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_LT_T2_AnC; ?>; }
	100% { color:<?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_LT_C; ?> !important; }
}
...
{
	position: relative;
	width: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_LT_FS*2; ?>px;
	height: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_LT_FS*2; ?>px;
...
<?php foreach($text_array as $key=>$v) { ?>
	...
	{
		background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_LT_T3_BgC; ?> !important;
		margin-right: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_LT_FS; ?>px !important;
...
@keyframes cssload-movement<?= $Rich_Web_VSlider_ID; ?>
{
	...
	to {
		...
		box-shadow: 0 24px 39px <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_LT_T3_BgC; ?>;
		background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_LT_T3_BgC; ?> !important;
	}
}
@-o-keyframes cssload-movement<?= $Rich_Web_VSlider_ID; ?>
{
	...
	to {
		...
		-o-box-shadow: 0 24px 39px <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_LT_T3_BgC; ?>;
		background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_LT_T3_BgC; ?> !important;
	}
}
@-ms-keyframes cssload-movement<?= $Rich_Web_VSlider_ID; ?>
{
	...
	to {
		...
		-ms-box-shadow: 0 24px 39px <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_LT_T3_BgC; ?>;
		background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_LT_T3_BgC; ?> !important;
	}
}
@-webkit-keyframes cssload-movement<?= $Rich_Web_VSlider_ID; ?>
{
	...
	to {
		...
		-webkit-box-shadow: 0 24px 39px <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_LT_T3_BgC; ?>;
		background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_LT_T3_BgC; ?> !important;
	}
}
@-moz-keyframes cssload-movement<?= $Rich_Web_VSlider_ID; ?>
{
	...
	to {
		...
		-moz-box-shadow: 0 24px 39px <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_LT_T3_BgC; ?>;
		background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_VSVT_LT_T3_BgC; ?> !important;
	}
}
.Rich_Web_VSVT<?= $Rich_Web_VSlider_ID; ?>_Main
{
	position: relative;
	margin: 0px auto;
	top: 20px;
	margin-bottom:50px;
	left: 0px;
	width: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_H*16/9+240;?>px;
	height: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_H;?>px;
	overflow: hidden;
	visibility: hidden;
	outline: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BW;?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BS;?> <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BC;?>;
	<?php if($Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BoxShShow=='on'){ ?>
		<?php if($Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BoxShType=='on'){ ?>
			-webkit-box-shadow: 0 30px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BoxSh;?>px -18px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BoxShC;?>;
			-moz-box-shadow: 0 30px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BoxSh;?>px -18px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BoxShC;?>;
			box-shadow: 0 30px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BoxSh;?>px -18px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BoxShC;?>;
		<?php }else{ ?>
			-webkit-box-shadow: 0px 0px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BoxSh;?>px 10px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BoxShC;?>;
			-moz-box-shadow: 0px 0px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BoxSh;?>px 10px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BoxShC;?>;
			box-shadow: 0px 0px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BoxSh;?>px 10px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BoxShC;?>;
		<?php }?>
	<?php }?>
...
.jssora05l, .jssora05r
{
	...
	overflow: hidden;
	padding: 1px;
	font-size: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_ArrFS;?>px;
	color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_ArrC;?>;
...
{
	-webkit-box-shadow: inset 0 0 6px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BgC;?>;
}
div[data-u="thumbnavigator"]::-webkit-scrollbar-thumb
{
	background-color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_Th_HBC;?>;
	outline: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_Th_HBC;?>;
}
...
.jssort01-99-66
{
	background-color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BgC;?>;
	position:absolute;
	left:0px;
	top:0px;
	width:240px;
...
.jssort01-99-66 .p
{
	...
	width: 99px;
	height: 66px;
	border: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_Th_BW;?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_Th_BS;?> <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_Th_BC;?> !important;
	border-radius: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_Th_BR;?>px;
	box-sizing:border-box !important;
}
.jssort01-99-66 .p:hover, .jssort01-99-66 .p.pdn, .jssort01-99-66 .pav
{
	border-color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_Th_HBC;?> !important;
}
.jssort01-99-66 .w  img
{
	border-radius: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_Th_BR-2;?>px;
}
...
.Rich_Web_VS_VTS_Title<?= $Rich_Web_VSlider_ID; ?>
{
	position:absolute;
	left:0px;
	width:100%;
	...
	padding: 2px;
	text-align: center;
	background-color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_TBgC;?>;
	color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_TC;?>;
	font-size: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_TFS;?>px;
	font-family: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_TFF;?>;
...
.Rich_Web_VS_VTS_Link<?= $Rich_Web_VSlider_ID; ?>
{
	position: absolute;
	<?php if($Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_LPos=='top-left'){ ?>
		left: <?= -$Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BW/($Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BW+1);?>px;
		top: <?= -$Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BW/($Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BW+1);?>px;
		border-bottom-right-radius: 70px;
		padding: 10px 20px 20px 10px;
	<?php }else if($Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_LPos=='top-right'){ ?>
		right: <?= -$Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BW/($Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BW+1);?>px;
		top: <?= -$Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BW/($Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BW+1);?>px;
		border-bottom-left-radius: 70px;
		padding: 10px 10px 20px 20px;
	<?php }else if($Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_LPos=='bottom-left'){ ?>
		left: <?= -$Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BW/($Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BW+1);?>px;
		bottom: <?= -$Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BW/($Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_BW+1);?>px;
	...
	<?php }?>
	z-index: 999999999;
	background-color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_LBgC;?>;
	font-size: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_LFS;?>px;
...
.Rich_Web_VS_VTS_Link<?= $Rich_Web_VSlider_ID; ?> a
{
	color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_LC;?>;
	text-decoration: none;
	box-shadow: none !important;
	border: none !important;
}
.Rich_Web_VS_VTS_Play<?= $Rich_Web_VSlider_ID; ?>
{
	position: absolute;
	...
	<?php }?>
	z-index: 999999999;
	background-color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_PBgC;?>;
	color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_PC;?>;
	font-size: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_PFS;?>px;
	-webkit-transition: all 0.5s ease-in-out;
	-moz-transition: all 0.5s ease-in-out;
	-o-transition: all 0.5s ease-in-out;
	-ms-transition: all 0.5s ease-in-out;
...
.Rich_Web_VS_VTS_Link<?= $Rich_Web_VSlider_ID; ?>:hover
{
	<?php if($Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_LPos=='top-left'){ ?>
	...
	<?php }?>
	background-color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_LHBgC;?>;
}
.Rich_Web_VS_VTS_Link<?= $Rich_Web_VSlider_ID; ?>:hover a
{
	color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_LHC;?>;
}
.Rich_Web_VS_VTS_Play<?= $Rich_Web_VSlider_ID; ?>:hover
{
	<?php if($Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_PPos=='top-left'){ ?>
	...
	<?php }?>
	background-color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_PHBgC;?>;
	color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_PHC;?>;
}
.Rich_Web_VSVT<?= $Rich_Web_VSlider_ID; ?>_Iframe_Div
{
	position: relative;
	top: 0px;
	left: 240px;
	width: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_H*16/9;?>px;
	height: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_H;?>px;
	overflow: hidden;
	display: none;
}
#Rich_Web_VSVT<?= $Rich_Web_VSlider_ID; ?>_Iframe
{
	width: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_H*16/9;?>px;
	height: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VTVS_H;?>px;
}
@media screen and (max-width:820px){
	.jssora05l, .jssora05r,.Rich_Web_VS_VTS_Play<?= $Rich_Web_VSlider_ID; ?>,.rich_web-link{
