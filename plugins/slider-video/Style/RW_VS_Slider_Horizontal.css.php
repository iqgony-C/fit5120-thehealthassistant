...
<style type="text/css">
					...
					#RW_Load_Horizontal_Navigation<?= $Rich_Web_VSlider_ID; ?>
					{
						position:relative;
						margin:20px auto !important;
						background-color:<?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_L_BgC; ?> !important;
						z-index:2;
						width:100%;
						padding-bottom:40%;
					...
					<?php if($Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_L_S == "small") { ?>
						...
						{
							border-top: 3px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_L_T1_C; ?> !important;
							border-bottom: 3px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_L_T1_C; ?> !important;
						}
						.loader_Navigation2<?= $Rich_Web_VSlider_ID; ?>
						{
							border-top: 3px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_L_T2_C; ?> !important;
							border-bottom: 3px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_L_T2_C; ?> !important;
						}
						.loader_Navigation3<?= $Rich_Web_VSlider_ID; ?>
						{
							border-top:12px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_L_T3_C; ?> !important;
							border-bottom:12px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_L_T3_C; ?> !important;
							border-right:12px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_L_T3_C; ?> !important;
							width:50% !important;
							height:50% !important;
						}
					<?php } elseif($Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_L_S == "middle") { ?>
						...
						.loader_Navigation1<?= $Rich_Web_VSlider_ID; ?>
						{
							border-top: 4px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_L_T1_C; ?> !important;
							border-bottom: 4px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_L_T1_C; ?> !important;
						}
						.loader_Navigation2<?= $Rich_Web_VSlider_ID; ?>
						{
							border-top: 4px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_L_T2_C; ?> !important;
							border-bottom: 4px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_L_T2_C; ?> !important;
						}
						.loader_Navigation3<?= $Rich_Web_VSlider_ID; ?>
						{
							border-top:17px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_L_T3_C; ?> !important;
							border-bottom:17px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_L_T3_C; ?> !important;
							border-right:17px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_L_T3_C; ?> !important;
							width:55% !important;
							height:55% !important;
						}
					<?php } else { ?>
						...
						.loader_Navigation1<?= $Rich_Web_VSlider_ID; ?>
						{
							border-top: 5px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_L_T1_C; ?> !important;
							border-bottom: 5px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_L_T1_C; ?> !important;
						}
						.loader_Navigation2<?= $Rich_Web_VSlider_ID; ?>
						{
							border-top: 5px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_L_T2_C; ?> !important;
							border-bottom: 5px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_L_T2_C; ?> !important;
						}
						.loader_Navigation3<?= $Rich_Web_VSlider_ID; ?>
						{
							border-top:25px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_L_T3_C; ?> !important;
							border-bottom:25px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_L_T3_C; ?> !important;
							border-right:25px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_L_T3_C; ?> !important;
							width:60% !important;
							height:60% !important;
						}
					<?php } ?>
					...
					.RW_Loader_Text_Navigation<?= $Rich_Web_VSlider_ID; ?>
					{
						...
						text-align:center;
						margin-top:10px;
						font-size: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_LT_FS; ?>px !important;
						font-family:<?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_LT_FF; ?> !important;
						color: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_LT_C; ?> !important;
					}
					...
					.loader<?= $Rich_Web_VSlider_ID; ?> div
					{
						...
						height: 8px;
						border-radius: 50%;
						border: 1px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_L_C; ?>;
						position: absolute;
						top: 2px;
						left: 0;
						right: 0;
					...
					.windows8<?= $Rich_Web_VSlider_ID; ?> .wBall .wInnerBall
					{
						...
						width: 10px;
						height: 10px;
						background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_L_C; ?>;
						left:0px;
						top:0px;
						border-radius: 10px;
					}
					...
					.cssload-thecube<?= $Rich_Web_VSlider_ID; ?> .cssload-cube:before
					{
						...
						width: 100%;
						height: 100%;
						background-color: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_L_C; ?>;
					...
					.cssload-loader<?= $Rich_Web_VSlider_ID; ?>::before, .cssload-loader<?= $Rich_Web_VSlider_ID; ?>::after
					{
						...
						width: 15px;
						height: 15px;
						background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_LT_T2_BC; ?> !important;
						position: absolute;
					...
					{
						0% { color:<?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_LT_T2_AnC; ?>; }
						100% { color:<?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_LT_C; ?> !important; }
					}
					...
					{
						position: relative;
						width: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_LT_FS*2; ?>px;
						height: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_LT_FS*2; ?>px;
					...
					<?php foreach($text_array as $key=>$v) { ?>
						...
						{
							background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_LT_T3_BgC; ?> !important;
							margin-right: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_LT_FS; ?>px !important;
					...
					@keyframes cssload-movement<?= $Rich_Web_VSlider_ID; ?>
					{
						...
						to {
							...
							box-shadow: 0 24px 39px <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_LT_T3_BgC; ?>;
							background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_LT_T3_BgC; ?> !important;
						}
					}
					@-o-keyframes cssload-movement<?= $Rich_Web_VSlider_ID; ?>
					{
						...
						to {
							...
							-o-box-shadow: 0 24px 39px <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_LT_T3_BgC; ?>;
							background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_LT_T3_BgC; ?> !important;
						}
					}
					@-ms-keyframes cssload-movement<?= $Rich_Web_VSlider_ID; ?>
					{
						...
						to {
							...
							-ms-box-shadow: 0 24px 39px <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_LT_T3_BgC; ?>;
							background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_LT_T3_BgC; ?> !important;
						}
					}
					@-webkit-keyframes cssload-movement<?= $Rich_Web_VSlider_ID; ?>
					{
						...
						to {
							...
							-webkit-box-shadow: 0 24px 39px <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_LT_T3_BgC; ?>;
							background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_LT_T3_BgC; ?> !important;
						}
					}
					@-moz-keyframes cssload-movement<?= $Rich_Web_VSlider_ID; ?>
					{
						...
						to {
							...
							-moz-box-shadow: 0 24px 39px <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_LT_T3_BgC; ?>;
							background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_HSL_LT_T3_BgC; ?> !important;
						}
					}
					#Rich_Web_VS_HPS<?= $Rich_Web_VSlider_ID; ?><?= $Rich_Web_VSlider_ID; ?>
					{
						display: block;
						max-width: 100%;
						min-width: 180px;
					...
					.crsl-items<?= $Rich_Web_VSlider_ID; ?> { display: block; padding: 4px; overflow: visible !important;}
					.crsl-item<?= $Rich_Web_VSlider_ID; ?> { padding: 8px;margin-bottom: 15px; }
					.crsl-item<?= $Rich_Web_VSlider_ID; ?> .thumbnail { display: block; position: relative; margin-bottom: 10px; cursor: pointer; }
					.crsl-item<?= $Rich_Web_VSlider_ID; ?> .thumbnail img
					{
						display: block;
					...
					.crsl-item<?= $Rich_Web_VSlider_ID; ?> h3 { line-height: 1; margin-bottom: 12px; text-transform:none !important; letter-spacing: inherit !important; }
					.crsl-item<?= $Rich_Web_VSlider_ID; ?> .postdate
					{
						display: block;
						position: absolute;
						bottom: 0;
					...
					.crsl-item<?= $Rich_Web_VSlider_ID; ?> p.readmore a { display: block; float: right; text-decoration: none; border: none !important; }
					.Rich_Web_VS_HPS<?= $Rich_Web_VSlider_ID; ?><?= $Rich_Web_VSlider_ID; ?>_Nav { display: block; text-align: center; margin-bottom: 5px; }
					.Rich_Web_VS_HPS<?= $Rich_Web_VSlider_ID; ?><?= $Rich_Web_VSlider_ID; ?>_Nav a { display: inline-block; padding: 5px 10px; margin-right: 8px; text-decoration: none; outline:none !important; }
					@media screen and (max-width: 660px) { h1 { font-size: 2.4em; line-height: 1.2em; } .crsl-item<?= $Rich_Web_VSlider_ID; ?> h3 { font-size: 1.65em; } }
					@media (min-width: 0) and (max-width: 600px)
					{
						.Rich_Web_VS_HPS<?= $Rich_Web_VSlider_ID; ?><?= $Rich_Web_VSlider_ID; ?>_Iframe_Div { width: 94% !important; left: 3% !important; top: 10% !important; }
					}
					.Rich_Web_VS_HPS<?= $Rich_Web_VSlider_ID; ?><?= $Rich_Web_VSlider_ID; ?>_clearfix:after { content: "."; display: block; clear: both; visibility: hidden; line-height: 0; height: 0; }
					.Rich_Web_VS_HPS<?= $Rich_Web_VSlider_ID; ?><?= $Rich_Web_VSlider_ID; ?>_clearfix { display: inline-block; }
					.Rich_Web_VS_HPS<?= $Rich_Web_VSlider_ID; ?><?= $Rich_Web_VSlider_ID; ?>_Nav a
					{
						color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_NP_C;?>;
						background-color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_NP_BgC;?>;
						font-size: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_NP_FS;?>px;
						font-family: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_NP_FF;?>;
						border: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_NP_BW;?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_NP_BS;?> <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_NP_BC;?>;
						-webkit-border-radius: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_NP_BR;?>px;
						-moz-border-radius: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_NP_BR;?>px;
						border-radius: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_NP_BR;?>px;
					...
					.Rich_Web_VS_HPS<?= $Rich_Web_VSlider_ID; ?><?= $Rich_Web_VSlider_ID; ?>_Nav a:hover
					{
						color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_NP_HC;?>;
						background-color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_NP_HBgC;?>;
					}
					.crsl-item<?= $Rich_Web_VSlider_ID; ?>
					{
						background: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_Cols_BgC;?>;
						-webkit-box-shadow: 0px 0px 3px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_Cols_BoxShC;?>;
						-moz-box-shadow: 0px 0px 3px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_Cols_BoxShC;?>;
						box-shadow: 0px 0px 3px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_Cols_BoxShC;?>;
					...
					.crsl-item<?= $Rich_Web_VSlider_ID; ?> .thumbnail img
					{
						...
						<?php }else if($Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_Cols_VSEff=='drop-shadow'){ ?>
							-webkit-filter: drop-shadow(0px 0px 5px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_Cols_StShC;?>);
							filter:drop-shadow(0px 0px 5px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_Cols_StShC;?>);
					...
					.crsl-item<?= $Rich_Web_VSlider_ID; ?> .thumbnail:hover img
					{
						...
						<?php }else if($Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_Cols_VHEff=='drop-shadow'){ ?>
							-webkit-filter: drop-shadow(0px 0px 5px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_Cols_HShC;?>);
							filter:drop-shadow(0px 0px 5px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_Cols_HShC;?>);
					...
					.crsl-item<?= $Rich_Web_VSlider_ID; ?> h3
					{
						color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_TC;?>;
						font-size: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_TFS;?>px;
						font-family: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_TFF;?>;
					}
					.crsl-item<?= $Rich_Web_VSlider_ID; ?> p
					{
						line-height: 1.2 !important;
						margin: 5px 0 !important;
						padding: 0 !important;
					}
					.crsl-item<?= $Rich_Web_VSlider_ID; ?> p.readmore a
					{
						color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_LC;?>;
						font-size: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_LFS;?>px;
						font-family: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_LFF;?>;
					}
					.crsl-item<?= $Rich_Web_VSlider_ID; ?> p.readmore a:hover
					{
						color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_LHC;?>;
					}
					.crsl-item<?= $Rich_Web_VSlider_ID; ?> .postdate
					{
						background: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_PBgC;?> !important;
						color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_PC;?>;
						font-size: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_PFS;?>px;
						font-family: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_PFF;?>;
					}
					.crsl-item<?= $Rich_Web_VSlider_ID; ?> .postdate:hover
					{
						background-color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_PHBgC;?>;
						color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_PHC;?>;
					}
					.Rich_Web_VS_HPS<?= $Rich_Web_VSlider_ID; ?><?= $Rich_Web_VSlider_ID; ?>_Overlay
					{
						position: fixed;
						height: 100%;
						width: 100%;
						background-color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_Pop_OvC;?>;
						top: 0;
						left: 0;
						z-index: 9999999999;
						cursor: pointer;
					...
					.Rich_Web_VS_HPS<?= $Rich_Web_VSlider_ID; ?><?= $Rich_Web_VSlider_ID; ?>_Iframe_Div1 { position: relative; width: 100%; padding-top: 56.25%; }
					.Rich_Web_VS_HPS<?= $Rich_Web_VSlider_ID; ?><?= $Rich_Web_VSlider_ID; ?>_Iframe_Text
					{
						position: absolute;
						top: 0;
						left: 0;
					...
					.Rich_Web_VS_HPS<?= $Rich_Web_VSlider_ID; ?><?= $Rich_Web_VSlider_ID; ?>_Iframe_Div
					{
						position: fixed;
						width: 50%;
						top: 25%;
						left: 25%;
						z-index: 9999999999;
						border: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_Pop_BW;?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_Pop_BS;?> <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_Pop_BC;?>;
						box-sizing: border-box !important;
						-moz-box-sizing: border-box !important;
						-webkit-box-sizing: border-box !important;
						display: none;
						<?php if($Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_Pop_BoxShShow=='on'){ ?>
							<?php if($Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_Pop_BoxShType=='on'){ ?>
								-webkit-box-shadow: 0 30px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_Pop_BoxSh;?>px -18px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_Pop_BoxShC;?>;
								-moz-box-shadow: 0 30px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_Pop_BoxSh;?>px -18px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_Pop_BoxShC;?>;
								box-shadow: 0 30px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_Pop_BoxSh;?>px -18px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_Pop_BoxShC;?>;
							<?php }else{ ?>
								-webkit-box-shadow: 0px 0px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_Pop_BoxSh;?>px 10px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_Pop_BoxShC;?>;
								-moz-box-shadow: 0px 0px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_Pop_BoxSh;?>px 10px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_Pop_BoxShC;?>;
								box-shadow: 0px 0px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_Pop_BoxSh;?>px 10px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_Pop_BoxShC;?>;
							<?php }?>
						<?php }?>
					}
					#Rich_Web_VS_HPS<?= $Rich_Web_VSlider_ID; ?><?= $Rich_Web_VSlider_ID; ?>_Iframe { width: 100%; height: 100%; }
					.Rich_Web_VS_HPS<?= $Rich_Web_VSlider_ID; ?><?= $Rich_Web_VSlider_ID; ?>_Overlay_Close
					{
						z-index: 99999999;
						color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_Pop_CIC;?>;
						font-size: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_VS_HPS_Pop_CIS;?>px;
						position: absolute;
						top: 5px;
						right: 5px;
						cursor: pointer;
					}
					.Rich_Web_VS_HPS<?= $Rich_Web_VSlider_ID; ?><?= $Rich_Web_VSlider_ID; ?>_Overlay_Close:hover { opacity: 0.8; }
					.crsl-items<?= $Rich_Web_VSlider_ID; ?>{ box-sizing:border-box; -moz-box-sizing:border-box; -webkit-box-sizing:border-box; }
					@media screen and (max-width: 820px){
						.crsl-item<?= $Rich_Web_VSlider_ID; ?> .thumbnail { cursor: default !important; }
					}
				</style>