                <link rel="stylesheet" href="<?= plugin_dir_url( __DIR__ ).'Style/rvslider.min.css';?>">
                <style>
					...
					#RW_Load_RS_Navigation<?= $Rich_Web_VSlider_ID; ?>
					{
						position:relative;
						margin:20px auto !important;
						background-color:<?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_L_BgC; ?> !important;
						z-index:2;
						width:750px;
						padding-bottom:50%;
					...
					<?php if($Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_L_S == "small") { ?>
						...
						{
							border-top: 3px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_L_T1_C; ?> !important;
							border-bottom: 3px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_L_T1_C; ?> !important;
						}
						.loader_Navigation2<?= $Rich_Web_VSlider_ID; ?>
						{
							border-top: 3px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_L_T2_C; ?> !important;
							border-bottom: 3px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_L_T2_C; ?> !important;
						}
						.loader_Navigation3<?= $Rich_Web_VSlider_ID; ?>
						{
							border-top:12px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_L_T3_C; ?> !important;
							border-bottom:12px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_L_T3_C; ?> !important;
							border-right:12px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_L_T3_C; ?> !important;
							width:50% !important;
							height:50% !important;
						}
					<?php } elseif($Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_L_S == "middle") { ?>
						...
						.loader_Navigation1<?= $Rich_Web_VSlider_ID; ?>
						{
							border-top: 4px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_L_T1_C; ?> !important;
							border-bottom: 4px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_L_T1_C; ?> !important;
						}
						.loader_Navigation2<?= $Rich_Web_VSlider_ID; ?>
						{
							border-top: 4px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_L_T2_C; ?> !important;
							border-bottom: 4px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_L_T2_C; ?> !important;
						}
						.loader_Navigation3<?= $Rich_Web_VSlider_ID; ?>
						{
							border-top:17px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_L_T3_C; ?> !important;
							border-bottom:17px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_L_T3_C; ?> !important;
							border-right:17px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_L_T3_C; ?> !important;
							width:55% !important;
							height:55% !important;
						}
					<?php } else { ?>
						...
						.loader_Navigation1<?= $Rich_Web_VSlider_ID; ?>
						{
							border-top: 5px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_L_T1_C; ?> !important;
							border-bottom: 5px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_L_T1_C; ?> !important;
						}
						.loader_Navigation2<?= $Rich_Web_VSlider_ID; ?>
						{
							border-top: 5px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_L_T2_C; ?> !important;
							border-bottom: 5px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_L_T2_C; ?> !important;
						}
						.loader_Navigation3<?= $Rich_Web_VSlider_ID; ?>
						{
							border-top:25px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_L_T3_C; ?> !important;
							border-bottom:25px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_L_T3_C; ?> !important;
							border-right:25px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_L_T3_C; ?> !important;
							width:60% !important;
							height:60% !important;
						}
					<?php } ?>
					...
					.RW_Loader_Text_Navigation<?= $Rich_Web_VSlider_ID; ?>
					{
						...
						text-align:center;
						margin-top:10px;
						font-size: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_LT_FS; ?>px !important;
						font-family:<?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_LT_FF; ?> !important;
						color: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_LT_C; ?> !important;
					}
					...
					.loader<?= $Rich_Web_VSlider_ID; ?> div
					{
						...
						height: 8px;
						border-radius: 50%;
						border: 1px solid <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_L_C; ?>;
						position: absolute;
						top: 2px;
						left: 0;
						right: 0;
					...
					.windows8<?= $Rich_Web_VSlider_ID; ?> .wBall .wInnerBall
					{
						...
						width: 10px;
						height: 10px;
						background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_L_C; ?>;
						left:0px;
						top:0px;
						border-radius: 10px;
					}
					...
					.cssload-thecube<?= $Rich_Web_VSlider_ID; ?> .cssload-cube:before
					{
						...
						width: 100%;
						height: 100%;
						background-color: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_L_C; ?>;
					...
					.cssload-loader<?= $Rich_Web_VSlider_ID; ?>::before, .cssload-loader<?= $Rich_Web_VSlider_ID; ?>::after
					{
						...
						width: 15px;
						height: 15px;
						background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_LT_T2_BC; ?> !important;
						position: absolute;
					...
					{
						0% { color:<?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_LT_T2_AnC; ?>; }
						100% { color:<?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_LT_C; ?> !important; }
					}
					...
					{
						position: relative;
						width: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_LT_FS*2; ?>px;
						height: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_LT_FS*2; ?>px;
					...
					<?php foreach($text_array as $key=>$v) { ?>
						...
						{
							background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_LT_T3_BgC; ?> !important;
							margin-right: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_LT_FS; ?>px !important;
					...
					@keyframes cssload-movement<?= $Rich_Web_VSlider_ID; ?>
					{
						...
						to {
							...
							box-shadow: 0 24px 39px <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_LT_T3_BgC; ?>;
							background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_LT_T3_BgC; ?> !important;
						}
					}
					@-o-keyframes cssload-movement<?= $Rich_Web_VSlider_ID; ?>
					{
						...
						to {
							...
							-o-box-shadow: 0 24px 39px <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_LT_T3_BgC; ?>;
							background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_LT_T3_BgC; ?> !important;
						}
					}
					@-ms-keyframes cssload-movement<?= $Rich_Web_VSlider_ID; ?>
					{
						...
						to {
							...
							-ms-box-shadow: 0 24px 39px <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_LT_T3_BgC; ?>;
							background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_LT_T3_BgC; ?> !important;
						}
					}
					@-webkit-keyframes cssload-movement<?= $Rich_Web_VSlider_ID; ?>
					{
						...
						to {
							...
							-webkit-box-shadow: 0 24px 39px <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_LT_T3_BgC; ?>;
							background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_LT_T3_BgC; ?> !important;
						}
					}
					@-moz-keyframes cssload-movement<?= $Rich_Web_VSlider_ID; ?>
					{
						...
						to {
							...
							-moz-box-shadow: 0 24px 39px <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_LT_T3_BgC; ?>;
							background: <?= $Rich_Web_VSlider_Eff_Loader[0]->Rich_Web_RichSl_LT_T3_BgC; ?> !important;
						}
					}
					.rvs-container<?= $Rich_Web_VSlider_ID; ?> { position:relative; margin-bottom:50px !important; max-width:100%; }
					.rvs-container<?= $Rich_Web_VSlider_ID; ?>_mobile { height:auto !important; }
					.rvs-item-stage<?= $Rich_Web_VSlider_ID; ?> { height:100% !important; }
					.rvs-item-stage<?= $Rich_Web_VSlider_ID; ?>_mobile { padding-bottom:56.25%; }
					<?php if($Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_ShT == "Type 1") {?>
						.rvs-container<?= $Rich_Web_VSlider_ID; ?>
						{
							box-shadow:0px 0px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_Sh; ?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_ShC; ?> !important;
							-moz-box-shadow:0px 0px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_Sh; ?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_ShC; ?> !important;
							-webkit-box-shadow:0px 0px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_Sh; ?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_ShC; ?> !important;
						}
					<?php } else { ?>
						.rvs-container<?= $Rich_Web_VSlider_ID; ?>
						{
							box-shadow:0px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_Sh/2; ?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_Sh; ?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_ShC; ?> !important;
							-moz-box-shadow:0px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_Sh/2; ?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_Sh; ?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_ShC; ?> !important;
							-webkit-box-shadow:0px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_Sh/2; ?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_Sh; ?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_ShC; ?> !important;
						}
					<?php } ?>
					.rvs-nav-container<?= $Rich_Web_VSlider_ID; ?> a.rvs-nav-item
					{
						border-top:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NI_BW; ?>px solid <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NI_BC; ?> !important;
					}
					.rvs-nav-container<?= $Rich_Web_VSlider_ID; ?> a.rvs-nav-item:hover
					{
						background-color:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NI_HBgC; ?> !important;
						border-color:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NI_HBC; ?> !important;
					}
					.rvs-nav-container<?= $Rich_Web_VSlider_ID; ?>
					{
						background-color:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NI_BgC; ?> !important;
					}
					.rvs-container<?= $Rich_Web_VSlider_ID; ?> a.rvs-nav-item.rvs-active
					{
						background-color:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NI_CBgC; ?> !important;
						border-color:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NI_CBC; ?> !important;
					}
					.rvs-nav-item-title<?= $Rich_Web_VSlider_ID; ?>
					{
						font-size: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NT_FS; ?>px !important;
						font-family:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NT_FF; ?> !important;
						color:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NT_C; ?> !important;
						line-height:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NT_FS+3; ?>px !important;
						text-transform:none !important;
						letter-spacing: 0 !important;
					}
					.rvs-nav-item:hover .rvs-nav-item-title<?= $Rich_Web_VSlider_ID; ?>
					{
						color:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NT_HC; ?> !important;
					}
					.rvs-active .rvs-nav-item-title<?= $Rich_Web_VSlider_ID; ?>
					{
						color:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NT_CC; ?> !important;
					}
					.rvs-nav-item-thumb<?= $Rich_Web_VSlider_ID; ?>
					{
						border:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NImg_BW; ?>px solid <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NScroll_HBgC; ?> !important;
						border-radius:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NImg_BR; ?>% !important;
					}
					<?php if($Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NImg_ShT == "Type 1") {?>
						.rvs-nav-item-thumb<?= $Rich_Web_VSlider_ID; ?>
						{
							box-shadow:0px 0px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NImg_BSh; ?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NImg_ShC; ?> !important;
							-moz-box-shadow:0px 0px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NImg_BSh; ?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NImg_ShC; ?> !important;
							-webkit-box-shadow:0px 0px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NImg_BSh; ?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NImg_ShC; ?> !important;
						}
					<?php } else { ?>
						.rvs-nav-item-thumb<?= $Rich_Web_VSlider_ID; ?>
						{
							box-shadow:0px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NImg_BSh/2; ?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NImg_BSh; ?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NImg_ShC; ?> !important;
							-moz-box-shadow:0px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NImg_BSh/2; ?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NImg_BSh; ?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NImg_ShC; ?> !important;
							-webkit-box-shadow:0px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NImg_BSh/2; ?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NImg_BSh; ?>px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NImg_ShC; ?> !important;
						}
					<?php } ?>
					.rvs-nav-prev<?= $Rich_Web_VSlider_ID; ?>
					{
						background:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NScroll_BgC; ?> !important;
						border-color:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NScroll_BgC; ?> !important;
						color:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NScroll_C; ?> !important;
					}
					.rvs-nav-next<?= $Rich_Web_VSlider_ID; ?>
					{
						background:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NScroll_BgC; ?> !important;
						border-color:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NScroll_BgC; ?> !important;
						color:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NScroll_C; ?> !important;
					}
					.rvs-item-text<?= $Rich_Web_VSlider_ID; ?>
					{
						font-size:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_IT_FS; ?>px !important;
						font-family:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_IT_FF; ?> !important;
						color:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_IT_C; ?> !important;
					}
					.rvs-item-text<?= $Rich_Web_VSlider_ID; ?> p
					{
						line-height: 1 !important;
						margin: 0 !important;
						padding: 0 !important;
					}
					.rvs-play-video<?= $Rich_Web_VSlider_ID; ?>:before
					{
						font-size:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_PlIc_FS; ?>px !important;
						color:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_PlIc_C; ?> !important;
						top:0% !important;
					...
					.rvs-play-video<?= $Rich_Web_VSlider_ID; ?>
					{
						width:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_PlIc_FS*2; ?>px !important;
						height:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_PlIc_FS*2; ?>px !important;
						line-height:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_PlIc_FS*2; ?>px !important;
					}
					.rvs-play-video<?= $Rich_Web_VSlider_ID; ?>
					{
						background-color:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_PlIc_BgC; ?> !important;
					}
					.rvs-play-video<?= $Rich_Web_VSlider_ID; ?>:hover
					{
						background-color:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_PlIc_HBgC; ?> !important;
					}
					.rw_rvs-close
					{
						position: absolute;
						color:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_DelIc_C; ?> !important;
						font-size:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_DelIc_FS; ?>px !important;
						top: 10px;
						left: 10px;
						padding: 5px 7px;
						background: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_DelIc_BgC; ?> !important;
						cursor: pointer;
						border-radius: 4px;
					...
					.rw_rvs-close:hover
					{
						background: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_DelIc_HBgC; ?> !important;
						text-decoration: none;
					}
					.rvs-nav-container<?= $Rich_Web_VSlider_ID; ?>::-webkit-scrollbar { width: 0.5em; }
					.rvs-nav-container<?= $Rich_Web_VSlider_ID; ?>::-webkit-scrollbar-track
					{
						-webkit-box-shadow: inset 0 0 6px <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NI_BgC; ?>;
					}
					.rvs-nav-container<?= $Rich_Web_VSlider_ID; ?>::-webkit-scrollbar-thumb
					{
						background-color: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NT_C; ?>;
						outline: <?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_NT_C; ?>;
					}
					...
					{
						.rvs-play-video<?= $Rich_Web_VSlider_ID; ?>:before{ font-size:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_PlIc_FS/2; ?>px !important; }
						.rvs-play-video<?= $Rich_Web_VSlider_ID; ?>
						{
							width:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_PlIc_FS; ?>px !important;
							height:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_PlIc_FS; ?>px !important;
							line-height:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_PlIc_FS/2+2; ?>px !important;
						}
						.rvs-item-text<?= $Rich_Web_VSlider_ID; ?>
						{
							font-size:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_IT_FS*2/3; ?>px !important;
							line-height:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_IT_FS*2/3+3; ?>px !important;
						}
						.rw_rvs-close
						{
							font-size:<?= $Rich_Web_VSlider_Eff[0]->Rich_Web_RVVS_DelIc_FS*2/3; ?>px !important;
							padding: 3px 5px;
						}
					}
				</style>