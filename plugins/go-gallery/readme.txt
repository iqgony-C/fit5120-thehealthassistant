=== Go Gallery ===
Contributors: alvimedia, infinitools
...
* Live Demo: [Live Demo](https://www.ampae.com/wp/go-gallery/demo/ "Live Demo")
* QuickStart: [QuickStart](https://www.ampae.com/wp/go-gallery/quickstart/ "QuickStart")

[youtube https://www.youtube.com/watch?v=yAWOKfRvPSQ]
...
Using same Idea Go Gallery Tags enables Tags instead of Categories in media images and adds filter menu to each gallery for easy and beautiful sorting.

* Go Gallery Tags: [Go Gallery Tags](https://wordpress.org/plugins/go-gallery-tags/ "Go Gallery Tags")
...
Deprecated:
 * overlay_color = color ‘#HTML’ of the image hover overlay. Now hover overlay color would be similar to the background of the gallery or border color if set.
...
[go_gallery cat='single, couple' size='large' visual='effect-square-small']
...
Go Gallery is Short-Code driven, plugin enable Media Categories for visual sorting purposes. You can find how to apply categories to the images and full list of shortcode options here: [QuickStart](https://alvimedia.com/go-gallery/quickstart/  "QuickStart")

= Where is Demo? =
You can find Online Demo here: [Live Demo](https://www.ampae.com/wp/go-gallery/demo/ "Live Demo")
...
* Added - New visual effects and new shortcode attribute 'visual'
* Removed - overlay_color shortcode attribute
* Updated - Main styles, plugin structure
* Updated - New LightBox and possibility to switch it on/off from shortcode attribute
