(function( $ ) {
	...
	$(document).ready(function () {
		...
		if($('#ifso_send_test_email').length>0){
			$('#ifso_send_test_email').on('click',function(){ajaxPost({action:'send_test_mail'},function(){alert('A testing email was sent successfully. Please check your spam folder if you do not see it in your inbox.')},function(){alert('Something went wrong! Please check your internet connection and try again!')})});
		}
