				...
				<tbody>
                    ...
                    <tr valign="top">
                        ...
                        <td valign="baseline">
                            ...
                            <i><?php _e('The "Triggers Visited" condition relies on this cookie. Check this box if you are planning to use thing condition.', 'if-so'); ?></i>
                        </td>
                    </tr>
                    ...
                    <tr valign="top">
                        ...
                        <td valign="baseline">
                            ...
                            <i><?php _e('Check this box to prevent no-cache headers from being sent as a result of If-So using PHP sessions.', 'if-so'); ?></i>
                        </td>
                    </tr>
                    <tr valign="top">
                        <td class="ifso-settings-td" scope="row" valign="baseline">
